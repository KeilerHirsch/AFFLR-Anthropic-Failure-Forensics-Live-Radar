...
| [#70847](https://github.com/anthropics/claude-code/issues/70847) | \[Bug\]\[aup\] Block stopped phishing/BEC triage of user's own mailbox: identifying compromised internal account s (req\_011CcPH3vmFMPzj6uapDHn21) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | api:anthropic, area:model, bug, duplicate, platform:linux, stale |
| [#70853](https://github.com/anthropics/claude-code/issues/70853) | \[Bug\]\[cyber\] IAM hardening review of M365/Exchange mail-flow rules and SPF/DMARC to close a self-spoof gap wro (req\_011CcPDx4ek1TQciJmgwmVdF) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, duplicate, platform:linux, stale |
| [#70891](https://github.com/anthropics/claude-code/issues/70891) | \[Bug\]\[cyber\] Auth-bypass security audit of admin SPA setup/recovery-token/session-token surfaces wrongly block (req\_011CcKDfBV227JiEaHcBfWfJ) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, bug, duplicate, platform:linux, stale |
| [#70902](https://github.com/anthropics/claude-code/issues/70902) | \[Bug\]\[aup\] Tenant IAM audit of admin roles, app registrations, and OAuth grants wrongly blocked (req\_011CcPp2TNJXj9pXGiKP1WHA) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | api:anthropic, area:model, bug, duplicate, platform:linux, stale |
| [#70903](https://github.com/anthropics/claude-code/issues/70903) | \[Bug\]\[cyber\] Cloud IAM tenant audit blocked: enumerating admin roles, app credentials, and OAuth consent grant (req\_011CcPpGWbfmDHqVJ1PmRch6) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, bug, duplicate, platform:linux, stale |
| [#70921](https://github.com/anthropics/claude-code/issues/70921) | \[Bug\]\[cyber\] Safety block stopped GeoIP lookup of a Telegram resolver IP while debugging IPv6 connectivity tim (req\_011CcJoGZ47fu82tzQQViLiH) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, bug, duplicate, platform:linux, stale |
| [#70924](https://github.com/anthropics/claude-code/issues/70924) | \[Bug\]\[cyber\] AD/M365 audit wrongly blocked: list distribution-group members with active mailboxes (req\_011CcHRaJHnvVgAPQoxCp8X8) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, duplicate, platform:linux, stale |
| [#70929](https://github.com/anthropics/claude-code/issues/70929) | \[Bug\]\[cyber\] Dashboard auth-gating and scoped log-reader module for internal RDP order-stats portal wrongly bl (req\_011CcHMXV6dDNviZ1YJmnmNi) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, duplicate, platform:linux, stale |
| [#70930](https://github.com/anthropics/claude-code/issues/70930) | \[Bug\]\[cyber\] Blocked adding a blur+pixelate overlay to gate dashboard data behind a login modal (req\_011CcHMVaE9RGa7inagpscQG) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, bug, duplicate, platform:linux, stale |
| [#70931](https://github.com/anthropics/claude-code/issues/70931) | \[Bug\]\[cyber\] False-positive safety block on building scoped log-reader module + order-stats dashboard for inte (req\_011CcHMSYfJPGRanZJNKLfvU) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, bug, duplicate, platform:linux, stale |
| [#70932](https://github.com/anthropics/claude-code/issues/70932) | \[Bug\]\[aup\] Provisioning a disposable test user account to validate access to a self-hosted RDS gateway (req\_011CcHCBRCs3A1EKC6vkeNw1) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | api:anthropic, area:model, bug, duplicate, platform:linux, stale |
| [#70939](https://github.com/anthropics/claude-code/issues/70939) | \[Bug\]\[cyber\] Safety block prevents admin VPN access to internal AD domain controller for routine server mainte (req\_011CcGz3y3RBmcuas3JBz8B5) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, bug, duplicate, platform:linux, stale |
| [#70940](https://github.com/anthropics/claude-code/issues/70940) | \[Bug\]\[aup\] Routing to an internal AD domain controller over an authorized admin VPN for defensive hardening wr (req\_011CcGys8ztxDdipsJzgsauN) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | api:anthropic, area:model, bug, duplicate, platform:linux, stale |
| [#70951](https://github.com/anthropics/claude-code/issues/70951) | \[Bug\]\[aup\] Safety block halts finalizing an authorized security assessment report on a cloud email account att (req\_011CcGvmeDnKtndSbPn61tJ2) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | api:anthropic, area:model, bug, duplicate, platform:linux, stale |
| [#70957](https://github.com/anthropics/claude-code/issues/70957) | \[Bug\]\[cyber\] Defensive hardening request to log plaintext-transmitting integration into encrypted audit DB wro (req\_011CcGvUjqu7wkujn86e122w) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, bug, duplicate, platform:linux, stale |
| [#70961](https://github.com/anthropics/claude-code/issues/70961) | \[Bug\]\[cyber\] Defensive Wazuh rule tuning to reclassify benign accounting-connector traffic flood wrongly block (req\_011CcGue9CDk4z2H7qWmuRiZ) | sworrl | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-06-25 | area:model, area:security, duplicate, platform:linux, stale |
