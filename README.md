...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#84352](https://github.com/anthropics/claude-code/issues/84352) | \[BUG\] CVP-approved Claude.ai organization still receives cyber safeguard blocks in Claude Code | federicolopeza | OPEN | 19 (👍 19) | 107 | 2026-08-16 | 2026-08-06 | — |
| [#81081](https://github.com/anthropics/claude-code/issues/81081) | \[BUG\] Session-start skill listing silently truncates most skill descriptions under a size budget | ralucaoda | OPEN | 0 | 2 | 2026-08-16 | 2026-07-25 | bug, documentation, reproduced |
| [#87190](https://github.com/anthropics/claude-code/issues/87190) | \[FEATURE\] Attach a terminal to a Remote Control session running on another machine | snappedToGrid | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:cli, enhancement |
| [#87180](https://github.com/anthropics/claude-code/issues/87180) | Cowork: scheduled-task prompt cannot be updated — even a single-paragraph prompt is rejected ("path traversal detected" / "failed to update") | agentneo16 | OPEN | 0 | 2 | 2026-08-16 | 2026-08-16 | area:cowork, area:desktop, bug, platform:macos |
| [#87189](https://github.com/anthropics/claude-code/issues/87189) | Artifact public sharing blocked: "This version can't be shared publicly" on every version and fresh artifacts (Max plan, CLI 2.1.233) | visitor-code | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:tools, bug, platform:macos |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87188](https://github.com/anthropics/claude-code/issues/87188) | Top-of-feed keyboard shortcut tip persists after disabling spinner tips | sleeve | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:tui, bug, platform:macos, user-experience |
| [#86014](https://github.com/anthropics/claude-code/issues/86014) | \[BUG\] Cross-session send\_message reports success but message is never delivered (stuck loading, 0/4 delivery) | lilysttail | OPEN | 3 (👍 3) | 8 | 2026-08-16 | 2026-08-12 | area:agents, bug, platform:windows |
| [#87186](https://github.com/anthropics/claude-code/issues/87186) | \[Feature Request\] PreToolUse/PostToolUse hooks lack access to live background task registry | sergeiwallace | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:hooks, enhancement |
| [#81836](https://github.com/anthropics/claude-code/issues/81836) | \[BUG\] Claude Desktop (Windows) — GPU process crash leaves main process hung, requires 'Repair' to relaunch | BindingEnergy | OPEN | 0 | 9 | 2026-08-16 | 2026-07-28 | — |
| [#80569](https://github.com/anthropics/claude-code/issues/80569) | \[Bug\] Agent-team teammates ignore effort frontmatter from subagent definitions | jonapich | OPEN | 1 (👍 1) | 3 | 2026-08-16 | 2026-07-23 | — |
| [#84997](https://github.com/anthropics/claude-code/issues/84997) | \[BUG\]  Are these model capable enough to create technology knowledge base? | gopalananth | CLOSED / COMPLETED | 0 | 1 | 2026-08-16 | 2026-08-08 | bug |
| [#74069](https://github.com/anthropics/claude-code/issues/74069) | \[Bug\] REPL cat() returns empty string ("") on repeat reads instead of a sentinel — downstream scripts truncate/clobber real files | dbl-0 | OPEN | 0 | 2 | 2026-08-16 | 2026-07-04 | area:tools, bug, has repro, platform:macos |
| [#76026](https://github.com/anthropics/claude-code/issues/76026) | \[MODEL\] Sonnet 5 is flagging UserPromptSubmit as prompt injections and refusing to follow instructions | gabriel-dehan | OPEN | 0 | 3 | 2026-08-16 | 2026-07-09 | area:hooks, area:model, bug, model, platform:aws-bedrock, reproduced |
| [#87187](https://github.com/anthropics/claude-code/issues/87187) | Design project API serves a stale snapshot while reporting success | CodeLifterIO | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:tools, bug, has repro |
| [#72675](https://github.com/anthropics/claude-code/issues/72675) | \[BUG\] Workflow tool: synthesis agent() returns placeholder schema values instead of real output on large aggregated input | CaitlinEverett | OPEN | 0 | 2 | 2026-08-16 | 2026-07-01 | api:anthropic, area:agents, bug, needs-repro, platform:macos, stale |
| [#72066](https://github.com/anthropics/claude-code/issues/72066) | \[BUG\] Claude Code doesn't work with \`NODE\_OPTIONS=--use-system-ca\` | GRiMe2D | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-16 | 2026-06-28 | area:networking, area:security, bug, has repro, platform:macos, regression, reproduced |
| [#74803](https://github.com/anthropics/claude-code/issues/74803) | \[BUG\] Burning through more tokens, while doing nothing different then before. | Kaoz-K | OPEN | 6 (👍 6) | 10 | 2026-08-16 | 2026-07-06 | area:cost, duplicate, needs-info, needs-repro |
| [#75613](https://github.com/anthropics/claude-code/issues/75613) | Headless \`claude -p\` hangs indefinitely at startup (no transcript, no output) — suspected untimed bg-daemon spare-worker handshake under memory pressure | ignatovv | OPEN | 0 | 2 | 2026-08-16 | 2026-07-08 | area:cli, area:core, bug, has repro, needs-repro, platform:macos |
| [#72426](https://github.com/anthropics/claude-code/issues/72426) | \[FEATURE\] Keyboard shortcut to open thread context menu (three-dots / right-click) in left panel | clkr | OPEN | 0 | 2 | 2026-08-16 | 2026-06-30 | area:desktop, enhancement, keybindings |
| [#29006](https://github.com/anthropics/claude-code/issues/29006) | Enable Remote Control for Claude Code sessions in Claude Desktop App | NickvZyl | OPEN | 159 (👍 120 · ❤️ 19 · 🚀 20) | 38 | 2026-08-16 | 2026-02-26 | area:desktop, enhancement |
| [#74699](https://github.com/anthropics/claude-code/issues/74699) | iTerm2: CLI launches as daemon child session, blocking Agents panel / session switching | biokraft | OPEN | 0 | 3 | 2026-08-16 | 2026-07-06 | area:agent-view, bug, platform:macos, reproduced |
| [#74423](https://github.com/anthropics/claude-code/issues/74423) | \[BUG\] Orphaned background Bash tasks spawned by a subagent keep running after 3 manual stops + refresh | jasminetsai-kleis | CLOSED / COMPLETED | 0 | 1 | 2026-08-16 | 2026-07-05 | area:agent-view, area:agents, area:tui, bug |
| [#74052](https://github.com/anthropics/claude-code/issues/74052) | \[BUG\] AskUserQuestion prompts fire Notification hook as notification\_type=permission\_prompt instead of a question-specific type | ajdinmore | OPEN | 0 | 2 | 2026-08-16 | 2026-07-04 | area:hooks, bug, has repro, platform:linux, reproduced |
| [#74216](https://github.com/anthropics/claude-code/issues/74216) | Model behavior: agent substitutes easier implementations for explicit specs, makes unverified 'done' claims, games user-defined enforcement hooks (7-day pattern) | jwuliger | OPEN | 0 | 2 | 2026-08-16 | 2026-07-04 | area:hooks, area:model, bug, needs-repro, platform:vscode, platform:windows, stale |
| [#73634](https://github.com/anthropics/claude-code/issues/73634) | \[BUG\] Subagent tasks set and billed to Sonnet-5 despite Haiku set as session model (v2.1.198) | JeffNasson | OPEN | 0 | 2 | 2026-08-16 | 2026-07-02 | api:anthropic, area:agents, area:cost, area:model, bug, needs-repro, platform:macos |
