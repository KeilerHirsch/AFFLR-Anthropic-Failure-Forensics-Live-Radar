...
| Issue | Title | State | Signal | Updated | Created | Labels |
|---:|---|---|---|---|---|---|
| [#88015](https://github.com/anthropics/claude-code/issues/88015) | \[Bug\] Anthropic API Error: Server rate limiting during request processing | OPEN | security / trust boundary · observation / provenance integrity | 2026-08-19 | 2026-08-19 | — |
...
| [#88003](https://github.com/anthropics/claude-code/issues/88003) | \[BUG\] PR Review skill burns through usage limits in 10 minutes and then loses all progress | OPEN | security / trust boundary | 2026-08-19 | 2026-08-19 | area:agents, area:cost, bug, platform:linux |
...
| [#88000](https://github.com/anthropics/claude-code/issues/88000) | \[Opus 5\] Model insult to user | OPEN | security / trust boundary · observation / provenance integrity | 2026-08-19 | 2026-08-19 | model |
| [#87999](https://github.com/anthropics/claude-code/issues/87999) | \[FEATURE\] VS Code extension: add prompt suggestions (ghost-text next prompts) like the terminal | OPEN | security / trust boundary | 2026-08-19 | 2026-08-19 | enhancement |
| [#87998](https://github.com/anthropics/claude-code/issues/87998) | Claude in Chrome extension not connecting from Cowork session (worked ~1 week ago) | OPEN | security / trust boundary | 2026-08-19 | 2026-08-19 | — |
...
| [#87984](https://github.com/anthropics/claude-code/issues/87984) | \[BUG\] Backgrounding a conversation (left arrow) continues it under a new session id; --resume shows a stalled duplicate of the original | OPEN | security / trust boundary · high-signal label | 2026-08-19 | 2026-08-19 | area:core, bug, has repro, platform:macos, reproduced |
