...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86470](https://github.com/anthropics/claude-code/issues/86470) | \[BUG\] claude-opus-4-6 uses 200K context window instead of 1M | kotdark | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | api:anthropic, area:model, bug, platform:macos |
| [#86469](https://github.com/anthropics/claude-code/issues/86469) | \[FEATURE\] Auto-expand enum option lists in MCP elicitation form dialogs | Rozart | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:mcp, area:tui, enhancement |
...
| [#75318](https://github.com/anthropics/claude-code/issues/75318) | \[BUG\] "Connection closed mid-response" (error=server\_error) terminates Agent-tool (Task) subagents mid-turn with no in-agent recovery — macOS, 2.1.201/2.1.202 | asawicki | OPEN | 0 | 1 | 2026-08-13 | 2026-07-07 | api:anthropic, area:agent, area:networking, bug, has repro, platform:macos |
| [#14202](https://github.com/anthropics/claude-code/issues/14202) | Bug: Project-scoped plugins incorrectly detected as installed globally | ianaswanson | OPEN | 64 (👍 63 · 👀 1) | 25 | 2026-08-13 | 2025-12-16 | area:core, bug, has repro |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#73697](https://github.com/anthropics/claude-code/issues/73697) | \[BUG\] Project-scope plugin installs are unremovable: uninstall says "enabled at project scope", disable says "already disabled" (still repro on v2.1.199; #62966 stale-closed) | innopoiesis | OPEN | 0 | 1 | 2026-08-13 | 2026-07-03 | area:plugins, bug, has repro, platform:windows |
| [#86468](https://github.com/anthropics/claude-code/issues/86468) | \[BUG\] ECONNRESET on streaming connections behind multi-layer NAT (macOS 26.6.1, v2.1.231) | Technophobe01 | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:networking, bug, has repro, platform:macos |
| [#86466](https://github.com/anthropics/claude-code/issues/86466) | \[BUG\] Can not bypass GIT on Windows Desktop | comps-usa | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | invalid |
| [#86467](https://github.com/anthropics/claude-code/issues/86467) | Plan mode needs a discuss/debate state that doesn't wipe the plan view | tilusnet | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:core, enhancement |
| [#86464](https://github.com/anthropics/claude-code/issues/86464) | \[BUG\] MCP progress notifications are received but discarded once a call is auto-backgrounded at 120s | EDmitry | OPEN | 0 | 1 | 2026-08-13 | 2026-08-13 | area:mcp, area:tui, bug, has repro, platform:macos |
| [#86465](https://github.com/anthropics/claude-code/issues/86465) | \[sonnet and opus\] Inability to use web search in dependency research | couryrr | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | api:anthropic, area:model, bug, model |
| [#49655](https://github.com/anthropics/claude-code/issues/49655) | \[BUG\] Claude Desktop update fails with 0x80073CF6 when CoworkVMService is running (Windows) | jun-ho-hong | OPEN | 10 (👍 10) | 20 | 2026-08-13 | 2026-04-17 | area:cowork, area:desktop, area:installation, bug, platform:windows |
| [#77752](https://github.com/anthropics/claude-code/issues/77752) | \[BUG\] Mouse tracking not disabled when Claude Code is suspended with Ctrl-Z | arinar | OPEN | 2 (👍 2) | 2 | 2026-08-13 | 2026-07-15 | area:tui, bug, has repro, platform:linux |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 0 | 1 | 2026-08-13 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#86463](https://github.com/anthropics/claude-code/issues/86463) | \[Bug\] Infinite loop in agentic cycle causing token waste | evanpaul90 | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:core, bug, needs-repro, platform:macos |
| [#86461](https://github.com/anthropics/claude-code/issues/86461) | \[FEATURE\] Reviewable draft-message relay between Home/chat threads (not Code sessions) | lennig | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:desktop, enhancement, platform:macos |
| [#86460](https://github.com/anthropics/claude-code/issues/86460) | \[Feature Request\] Option to use git branch name as the session title (desktop app has no way to automate this) | namiranianp | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:desktop, area:tui, enhancement |
| [#86462](https://github.com/anthropics/claude-code/issues/86462) | \[BUG\] Claude Code repeatedly ignores my documented (and re-stated) rules about not triggering needless permission prompts | offby1 | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:model, area:permissions, bug, platform:macos |
...
| [#86458](https://github.com/anthropics/claude-code/issues/86458) | \[Bug\] Fable 5 declines explicitly assigned work and insists on delegating it to another agent, immediately after weekly-allowance waste from recovery loops | mistywidow | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:model, bug, platform:vscode, platform:windows |
| [#86457](https://github.com/anthropics/claude-code/issues/86457) | \[Bug\] Tool cannot color font and adapt space during clone operation | andreapeterfly-prog | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:tui, bug, needs-repro, platform:macos |
| [#78759](https://github.com/anthropics/claude-code/issues/78759) | Argument substitution corrupts literal $N text (prices, awk fields) in command/skill file content — including fenced code blocks; no opt-out | bboretzky | OPEN | 0 | 5 | 2026-08-13 | 2026-07-18 | area:skills, bug, has repro |
| [#86456](https://github.com/anthropics/claude-code/issues/86456) | Queued cross-session message lands cleanly but doesn't trigger a new agent turn until something else flushes the queue | thomiasj | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:agents, duplicate |
| [#86455](https://github.com/anthropics/claude-code/issues/86455) | \[Bug\] Anthropic API Error: Safety filter blocking legitimate security scanning tasks | tsawler | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:model, bug, duplicate, platform:macos |
| [#73944](https://github.com/anthropics/claude-code/issues/73944) | \[BUG\] Cursor flashes on every screen update (even while typing) in tmux | solace-rcampbell | OPEN | 0 | 4 | 2026-08-13 | 2026-07-03 | area:tui, bug, platform:linux, regression |
