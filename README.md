...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86923](https://github.com/anthropics/claude-code/issues/86923) | \[Feature Request\] Display editor access keybinding for plan mode in help area | ericnewton76 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | — |
| [#86922](https://github.com/anthropics/claude-code/issues/86922) | Feature request: Translate all UI text to Chinese | gutianyu07-source | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:ide, enhancement, platform:vscode |
| [#86921](https://github.com/anthropics/claude-code/issues/86921) | \[Feature Request\] Add inter-chat communication or context sharing between separate conversations | enkr1 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:cowork, enhancement, platform:macos |
| [#86920](https://github.com/anthropics/claude-code/issues/86920) | \[Feature Request\] Show task completion percentage in the status line, not just elapsed time | fabenaliam | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:statusline, enhancement, platform:macos |
...
| [#86919](https://github.com/anthropics/claude-code/issues/86919) | \[BUG\] policy-limits.json security restriction silently stripped, recurring within a single session | intercomdirect | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:core, area:security, bug, platform:windows |
...
| [#73322](https://github.com/anthropics/claude-code/issues/73322) | Bare inline triple backticks in a message make the fullscreen renderer display the ENTIRE message as raw markdown (2.1.198, macOS, WezTerm) | KasparOrange | OPEN | 0 | 2 | 2026-08-15 | 2026-07-02 | area:tui, bug, has repro, platform:macos |
| [#86918](https://github.com/anthropics/claude-code/issues/86918) | AskUserQuestion never times out while the terminal is focused | marcospgp | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:tui, bug, platform:macos |
| [#38981](https://github.com/anthropics/claude-code/issues/38981) | Feature Request: Hierarchical skill resolution via directory traversal | ellardcs | CLOSED / NOT\_PLANNED | 3 (👍 3) | 6 | 2026-08-15 | 2026-03-25 | area:skills, enhancement, stale |
| [#49532](https://github.com/anthropics/claude-code/issues/49532) | Feature request: lazy skill loading for plugins with many skills | lucabattistini | CLOSED / NOT\_PLANNED | 0 | 3 | 2026-08-15 | 2026-04-16 | area:plugins, area:skills, enhancement, stale |
| [#59283](https://github.com/anthropics/claude-code/issues/59283) | Feature Request: Option to hide/collapse tool call panel headers in Agent SDK environment | zeronimo123 | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-05-15 | area:agent-sdk, enhancement, platform:windows, stale, user-experience |
| [#50348](https://github.com/anthropics/claude-code/issues/50348) | \[BUG\] Cowork "Virtualization is not available" — Virtual Machine Platform not responding | Saran-tech24 | CLOSED / NOT\_PLANNED | 0 | 5 | 2026-08-15 | 2026-04-18 | area:cowork, duplicate, platform:windows, stale |
| [#53252](https://github.com/anthropics/claude-code/issues/53252) | ultrareview: failed Find phase consumed free quota slot (empty results, ~10s heartbeats) | majinjacques | CLOSED / NOT\_PLANNED | 2 (👍 2) | 5 | 2026-08-15 | 2026-04-25 | area:cost, area:skills, bug, platform:web, stale |
| [#59279](https://github.com/anthropics/claude-code/issues/59279) | \[BUG\] 529에러 | issacs | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-05-15 | api:anthropic, duplicate, external, platform:windows, stale |
| [#59280](https://github.com/anthropics/claude-code/issues/59280) | /init hangs / times out on an empty directory instead of failing fast | searayca | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-05-15 | stale |
| [#45981](https://github.com/anthropics/claude-code/issues/45981) | Agent made destructive YouTube changes applied wrong data and falsely reported completion | victoriapinder | CLOSED / NOT\_PLANNED | 0 | 9 | 2026-08-15 | 2026-04-10 | area:agent, area:model, bug, platform:macos, stale |
| [#57042](https://github.com/anthropics/claude-code/issues/57042) | \[Bug\] Claude generates hallucinated content without grounding in provided context | stulentsev | CLOSED / NOT\_PLANNED | 0 | 7 | 2026-08-15 | 2026-05-07 | area:model, bug, needs-repro, platform:macos, stale |
| [#59060](https://github.com/anthropics/claude-code/issues/59060) | \[FEATURE\] IsReadInSession(path) query tool / --check-read-state flag | haabe | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-15 | 2026-05-14 | area:tools, enhancement, stale |
| [#47711](https://github.com/anthropics/claude-code/issues/47711) | Memory leak: ~930 MB/min growth in v2.1.101 | zacaffeinemachine | CLOSED / NOT\_PLANNED | 4 (👍 4) | 6 | 2026-08-15 | 2026-04-14 | bug, duplicate, has repro, perf:memory, platform:linux, regression, stale |
| [#59063](https://github.com/anthropics/claude-code/issues/59063) | GitHub Copilot reading .claude/ configuration directory without explicit consent | krishnanmk | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-05-14 | area:security, platform:vscode, question, stale |
| [#59059](https://github.com/anthropics/claude-code/issues/59059) | \[FEATURE\] Live artifacts: allow sidebar display name to be renamed independently of id slug | alemuenchen | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-15 | 2026-05-14 | area:cowork, enhancement, stale |
