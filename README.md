...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86788](https://github.com/anthropics/claude-code/issues/86788) | /model: picker checkmark tracks the default instead of the active session override; full model ID silently drops the \[1m\] suffix | Phantomx2k2 | OPEN | 0 | 1 | 2026-08-15 | 2026-08-14 | area:ide, area:model, bug, has repro, platform:macos, platform:vscode |
...
| [#24798](https://github.com/anthropics/claude-code/issues/24798) | Inter-session communication for multi-Claude workflows | hmcg001 | OPEN | 21 (👍 21) | 73 | 2026-08-15 | 2026-02-10 | area:core, area:tui, enhancement |
...
| [#86859](https://github.com/anthropics/claude-code/issues/86859) | \[BUG\] Desktop app (Windows): near-daily GPU process crashes (exitCode 101457950) + RADAR\_PRE\_LEAK\_64 memory leak report | Suchspezi | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:desktop, bug, perf:memory, platform:windows |
| [#86397](https://github.com/anthropics/claude-code/issues/86397) | \[FEATURE\] To avoid stale interactions: Store the timestamp of each interaction in Claude Code and sort them | aaronortiz | OPEN | 0 | 1 | 2026-08-15 | 2026-08-13 | area:tui, enhancement |
| [#72459](https://github.com/anthropics/claude-code/issues/72459) | Expose per-message timestamps to Claude's context (Cowork + Chat gap — no workaround available) | nikolaym01 | OPEN | 1 (👍 1) | 1 | 2026-08-15 | 2026-06-30 | area:core, area:cowork, enhancement |
| [#86858](https://github.com/anthropics/claude-code/issues/86858) | \[BUG\] Remote Control: sessions started from the Android app ignore settings.json permissions.defaultMode=bypassPermissions and run in auto mode (CLI-started sessions honour it) | pandora2000 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:permissions, bug, has repro, platform:android |
| [#86474](https://github.com/anthropics/claude-code/issues/86474) | \[BUG\] updating claude on Windows does not work | tomburge | OPEN | 0 | 1 | 2026-08-15 | 2026-08-13 | area:installation, bug, has repro, platform:windows |
| [#86367](https://github.com/anthropics/claude-code/issues/86367) | Browser pane: service-worker registration fails — script fetch never leaves the app | netopolit | OPEN | 1 (👍 1) | 1 | 2026-08-15 | 2026-08-13 | area:desktop, bug, has repro, platform:macos |
| [#86856](https://github.com/anthropics/claude-code/issues/86856) | \[Bug\] Fable safeguards incorrectly flagging legitimate security validation code | xR4cer | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:model, bug, platform:windows |
| [#34255](https://github.com/anthropics/claude-code/issues/34255) | \[BUG\] Remote Control: automatic reconnection doesn't work -- connection drops silently with no recovery | BluCreator | OPEN | 103 (👍 103) | 63 | 2026-08-15 | 2026-03-14 | bug, platform:ios, platform:macos |
| [#84352](https://github.com/anthropics/claude-code/issues/84352) | \[BUG\] CVP-approved Claude.ai organization still receives cyber safeguard blocks in Claude Code | federicolopeza | OPEN | 18 (👍 18) | 99 | 2026-08-15 | 2026-08-06 | — |
