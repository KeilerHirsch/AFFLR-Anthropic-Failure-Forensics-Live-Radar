...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#69792](https://github.com/anthropics/claude-code/issues/69792) | \[Bug\] Non-ASCII characters appearing unexpectedly in Claude Code output | matthew-semasoftware | OPEN | 0 | 4 | 2026-08-13 | 2026-06-20 | area:model, bug, platform:macos |
| [#81396](https://github.com/anthropics/claude-code/issues/81396) | \[BUG\] Missing HCS services: vfpext — corrupt component manifest (CSI) blocks driver deployment, manual load fails with ERROR 193 | PanzerIhnen | OPEN | 0 | 2 | 2026-08-13 | 2026-07-26 | bug |
| [#72376](https://github.com/anthropics/claude-code/issues/72376) | \[BUG\] Claude steals focus on startup in vscode | LiamMorrow | OPEN | 3 (👍 3) | 2 | 2026-08-13 | 2026-06-29 | area:ide, bug, platform:macos, platform:vscode |
| [#86407](https://github.com/anthropics/claude-code/issues/86407) | \[Bug\] Inappropriate content policy block on firmware analysis task | skylerwshaw | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:model, bug, platform:macos |
| [#86406](https://github.com/anthropics/claude-code/issues/86406) | \[BUG\] \`/goal clear\` typed while the agent is working is treated as chat text and never executed | CaptainException | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:tui, bug, needs-info, platform:macos |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#79756](https://github.com/anthropics/claude-code/issues/79756) | \[FEATURE\]  specificity-aware permission precedence (let a narrow allow override a broad deny) | saleem-mirza | OPEN | 0 | 2 | 2026-08-13 | 2026-07-21 | enhancement |
| [#83175](https://github.com/anthropics/claude-code/issues/83175) | \[BUG\] Grep content output: text before the first colon of context lines is path-normalized on Windows (single-file searches; '//' becomes '\\') | silkfire | OPEN | 1 (👍 1) | 4 | 2026-08-13 | 2026-08-01 | bug |
| [#83809](https://github.com/anthropics/claude-code/issues/83809) | \[BUG\] Allow "cancelled" agents to be resumed anyway | skerit | OPEN | 2 (👍 2) | 3 | 2026-08-13 | 2026-08-04 | bug |
| [#86405](https://github.com/anthropics/claude-code/issues/86405) | \[Bug\] PreToolUse/PostToolUse hooks not fired for subagent tool calls | CVanF5 | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:agents, area:hooks, bug, platform:macos |
| [#86361](https://github.com/anthropics/claude-code/issues/86361) | \[BUG\] ​/goal​ reports "No goal set" while the goal is still set after a mid-session CLI auto-update | CaptainException | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | bug |
| [#32870](https://github.com/anthropics/claude-code/issues/32870) | \[BUG\] claude.exe triggers Windows BSOD via Wof.sys during directory listing (NtQueryDirectoryFileEx) | VRDate | OPEN | 1 (👍 1) | 40 | 2026-08-13 | 2026-03-10 | bug, external, has repro, platform:windows |
| [#86308](https://github.com/anthropics/claude-code/issues/86308) | \[BUG\] GitHub connector missing entirely from mobile app connector list (private account) — not just disconnected | jensfiedler | OPEN | 0 | 1 | 2026-08-13 | 2026-08-13 | invalid |
| [#80912](https://github.com/anthropics/claude-code/issues/80912) | Windows kernel BSOD (0x139) in VS Code session — same signature as #30137 | SergioMartinsPereira | OPEN | 0 | 7 | 2026-08-13 | 2026-07-24 | bug |
| [#29006](https://github.com/anthropics/claude-code/issues/29006) | Enable Remote Control for Claude Code sessions in Claude Desktop App | NickvZyl | OPEN | 159 (👍 120 · ❤️ 19 · 🚀 20) | 37 | 2026-08-13 | 2026-02-26 | area:desktop, enhancement |
| [#86404](https://github.com/anthropics/claude-code/issues/86404) | \[Bug\] Anthropic API Error: Message flagged by Claude safeguards policy | arateb | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:model, bug, platform:linux |
| [#86403](https://github.com/anthropics/claude-code/issues/86403) | \[FEATURE\] Option to open Claude in the active editor group | EspritElf | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | area:ide, enhancement, platform:vscode |
| [#86402](https://github.com/anthropics/claude-code/issues/86402) | Desktop app File viewer: clicking an .html file shows source only — it used to open a rendered preview | jameswasher | OPEN | 0 | 1 | 2026-08-13 | 2026-08-13 | area:desktop, bug, platform:macos, regression |
...
| [#84918](https://github.com/anthropics/claude-code/issues/84918) | \[FEATURE\]  Session/chat history and memory in Claude Code are keyed entirely to the project folder's absolute filesystem path, with no way to preserve continuity when the folder is moved or renamed. | Gene-Howard | OPEN | 0 | 1 | 2026-08-13 | 2026-08-07 | enhancement |
| [#86401](https://github.com/anthropics/claude-code/issues/86401) | \[Feature Request\] Enable voice mode support in remote control sessions | imccart | OPEN | 0 | 0 | 2026-08-13 | 2026-08-13 | enhancement, platform:windows |
| [#86058](https://github.com/anthropics/claude-code/issues/86058) | \[BUG\] Agent frontmatter \`model: opus\` runs the parent session model instead of stepping down to the newest org-allowed Opus (per-invocation \`model: opus\` param steps down correctly) | ondrejtucny | OPEN | 0 | 1 | 2026-08-13 | 2026-08-12 | area:agents, area:plugins, bug, has repro, platform:windows |
| [#83133](https://github.com/anthropics/claude-code/issues/83133) | A skill's unresolvable \`agent:\` silently falls back to \`general-purpose\`, widening its toolset | gbuildz | OPEN | 1 (👍 1) | 3 | 2026-08-13 | 2026-08-01 | — |
| [#66426](https://github.com/anthropics/claude-code/issues/66426) | \[BUG billing\] Got silently upgraded to Max plan from Pro without my consent. I got charged 200$ and no refund twice. | DavideRiccitiello | CLOSED / NOT\_PLANNED | 0 | 3 | 2026-08-13 | 2026-06-09 | invalid |
| [#66365](https://github.com/anthropics/claude-code/issues/66365) | \[Bug\] Console billing: Tax calculation not resolving in checkout form | Edrygr | CLOSED / NOT\_PLANNED | 1 (👍 1) | 2 | 2026-08-13 | 2026-06-08 | invalid |
| [#66233](https://github.com/anthropics/claude-code/issues/66233) | \[Bug\] Text output corruption in Kitty terminal with cell drift | QWASS | CLOSED / DUPLICATE | 0 | 3 | 2026-08-13 | 2026-06-08 | duplicate |
