...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86176](https://github.com/anthropics/claude-code/issues/86176) | \[MODEL\] | dami-gupta-git | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | model |
| [#85852](https://github.com/anthropics/claude-code/issues/85852) | \[FEATURE\] Side-by-side diffs | Neptilo | OPEN | 0 | 1 | 2026-08-12 | 2026-08-11 | area:tui, duplicate |
| [#79523](https://github.com/anthropics/claude-code/issues/79523) | \[BUG\] Issues are labeled as duplicates without referencing the original issue | marcindulak | OPEN | 1 (👍 1) | 3 | 2026-08-12 | 2026-07-20 | bug |
| [#84683](https://github.com/anthropics/claude-code/issues/84683) | \[BUG\] Gateway model discovery never issues /v1/models request when auth uses apiKeyHelper (v2.1.223) | tylerfloyd | OPEN | 0 | 4 | 2026-08-12 | 2026-08-07 | bug |
| [#86175](https://github.com/anthropics/claude-code/issues/86175) | preview\_start prompts in every permission mode since desktop 1.28929.0; approval is in-memory per-chat and cannot be allowlisted | lsweigart12 | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | area:desktop, area:permissions, area:tools, bug, documentation, has repro, platform:macos |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#56331](https://github.com/anthropics/claude-code/issues/56331) | Sandbox auto-adds config/ to denyWithinAllow, breaking git checkout across refs | davidgm0 | OPEN | 3 (👍 3) | 8 | 2026-08-12 | 2026-05-05 | area:sandbox, bug, platform:macos |
| [#86174](https://github.com/anthropics/claude-code/issues/86174) | \[BUG\] ListAgents/list-agents returns empty while team is alive — leadSessionId not re-bound after session resume/clear | Lombey | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | area:agents, bug, has repro, platform:linux |
| [#76721](https://github.com/anthropics/claude-code/issues/76721) | \[FEATURE\] Stop-hook continuations render below the final answer — no way to keep the answer visually last | AkashGoenka | OPEN | 0 | 1 | 2026-08-12 | 2026-07-11 | area:hooks, area:tui, enhancement |
| [#85236](https://github.com/anthropics/claude-code/issues/85236) | MCP OAuth: per-process refresh lock lets concurrent sessions race token refresh; rotation-strict servers revoke the token family, forcing manual re-auth | hausenpepper | OPEN | 0 | 0 | 2026-08-12 | 2026-08-09 | — |
| [#83731](https://github.com/anthropics/claude-code/issues/83731) | \[MODEL\] Opus 5 (1M) reports itself "out of context" at 28-50% usage and stops working; Opus 4.8 does not | alphanin9 | OPEN | 1 (👍 1) | 2 | 2026-08-12 | 2026-08-04 | — |
| [#84352](https://github.com/anthropics/claude-code/issues/84352) | \[BUG\] CVP-approved Claude.ai organization still receives cyber safeguard blocks in Claude Code | federicolopeza | OPEN | 12 (👍 12) | 78 | 2026-08-12 | 2026-08-06 | — |
| [#85322](https://github.com/anthropics/claude-code/issues/85322) | \[Bug\] Streams die under long thinking gaps: 180s first-party idle abort + retry permanently disabled after one visible block | HectorBernstorff | OPEN | 0 | 2 | 2026-08-12 | 2026-08-09 | — |
| [#86173](https://github.com/anthropics/claude-code/issues/86173) | CLI: model narrates a "side panel" that doesn't exist in the terminal when sending files | kristoffersingleton-yale | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | area:model, area:tui, bug, platform:macos |
| [#85884](https://github.com/anthropics/claude-code/issues/85884) | macOS: Read of an image &gt;~200KB deadlocks every subsequent API call (surfaces as ECONNRESET after retry ladder); session permanently poisoned incl. --resume | Iteratrix | OPEN | 0 | 2 | 2026-08-12 | 2026-08-11 | area:tools, bug, has repro, platform:macos |
| [#86172](https://github.com/anthropics/claude-code/issues/86172) | Skill \`model:\` frontmatter ignored in interactive sessions (works in \`claude -p\`) — v2.1.228 | rebecca-boom | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | area:skills, bug, duplicate, platform:macos |
| [#42765](https://github.com/anthropics/claude-code/issues/42765) | \[BUG\] OAuth redirect\_uri uses localhost instead of 127.0.0.1, violating RFC 8252 Section 7.3 | alzerid | OPEN | 26 (👍 26) | 13 | 2026-08-12 | 2026-04-02 | area:auth, area:mcp, bug, has repro, platform:linux |
| [#86164](https://github.com/anthropics/claude-code/issues/86164) | \[BUG\] MCP stdio client fails on specific tool responses from a healthy, freshly-spawned server (works fine via raw JSON-RPC probe) | matt-raffel-kiva | OPEN | 0 | 1 | 2026-08-12 | 2026-08-12 | area:mcp, bug, platform:macos |
