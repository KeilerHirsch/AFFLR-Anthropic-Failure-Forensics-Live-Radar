...
| [#87199](https://github.com/anthropics/claude-code/issues/87199) | Process name in Activity Monitor/ps is the version string (2.1.233), not claude | ahammond | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:packaging, bug, platform:macos |
| [#87198](https://github.com/anthropics/claude-code/issues/87198) | \[Bug\] Request blocked with unclear error message | henriquetroiano | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:model, bug, needs-info, platform:linux |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87197](https://github.com/anthropics/claude-code/issues/87197) | False "Update available!" notice repeats on idle, even when apt-managed install is already latest | AlanKrueger | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | area:packaging, bug, has repro, platform:linux |
| [#87196](https://github.com/anthropics/claude-code/issues/87196) | Repeated failed troubleshooting loop wasted significant time/tokens (Expo Go tunnel setup) | cosim3434-debug | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | area:model, bug |
| [#80306](https://github.com/anthropics/claude-code/issues/80306) | In-app browser (Browser pane) crashes entire app when a page loads a Cloudflare Turnstile/verification challenge | dreman1166-maker | OPEN | 0 | 1 | 2026-08-16 | 2026-07-22 | — |
| [#78175](https://github.com/anthropics/claude-code/issues/78175) | AskUserQuestion: empty "Other" input cancels the whole dialog, discarding already-answered questions | marcospgp | OPEN | 0 | 1 | 2026-08-16 | 2026-07-16 | area:tools, area:tui, bug, platform:macos, reproduced |
| [#74081](https://github.com/anthropics/claude-code/issues/74081) | Linux sandbox: recursive Read() deny globs expand to per-file bwrap binds → E2BIG on every command (incl. echo hello) when a denied directory holds many files | LN405Rx | OPEN | 3 (👍 3) | 1 | 2026-08-16 | 2026-07-04 | area:sandbox, bug, platform:linux, platform:wsl |
| [#87195](https://github.com/anthropics/claude-code/issues/87195) | Session hangs indefinitely mid-turn: ide MCP tool calls (auto getDiagnostics on Write) have no timeout, while connect does | ropazo | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:ide, area:mcp, bug, has repro, platform:intellij, platform:wsl |
| [#87193](https://github.com/anthropics/claude-code/issues/87193) | \[BUG\] Remote Control: new session from claude.ai reuses the pre-created session's conversation (deterministic v5 session id) | Mathias5 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:core, bug, has repro, platform:linux |
| [#87194](https://github.com/anthropics/claude-code/issues/87194) | \[BUG\] Claude Desktop 1.30096.5 hangs before creating a window on macOS | halseey | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | invalid |
| [#85749](https://github.com/anthropics/claude-code/issues/85749) | Claude Code on the web: messages alternate between two concurrent conversations in the same container, with no indication in the UI | eggnstone | OPEN | 0 | 1 | 2026-08-16 | 2026-08-11 | area:claude-code-web, bug, platform:web |
| [#84702](https://github.com/anthropics/claude-code/issues/84702) | \[Bug\] Chat scroll broken after navigation back from agents view | rynz | OPEN | 1 (👍 1) | 1 | 2026-08-16 | 2026-08-07 | — |
| [#81658](https://github.com/anthropics/claude-code/issues/81658) | \[BUG\] Cross-platform sync failure (Desktop/Web/Android) causing Cowork conversations and chats to disappear — suspected server-side incident | HSBE31 | OPEN | 4 (👍 4) | 10 | 2026-08-16 | 2026-07-27 | bug |
| [#84689](https://github.com/anthropics/claude-code/issues/84689) | \[BUG\] CVP approved org still blocked by cyber safeguards — org ID confirmed matching, appeal form shows no fields | RenzyXSec | OPEN | 0 | 11 | 2026-08-16 | 2026-08-07 | bug |
| [#87192](https://github.com/anthropics/claude-code/issues/87192) | Login reports success but never persists the credential (macOS Keychain) — silent auth loop on 2.1.223 and 2.1.232 | MishaPT | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:auth, bug, has repro, platform:macos |
| [#84019](https://github.com/anthropics/claude-code/issues/84019) | \[BUG\] Notion connector OAuth fails with "Invalid authorization request" | SudoScare | OPEN | 2 (👍 2) | 4 | 2026-08-16 | 2026-08-05 | bug |
| [#84352](https://github.com/anthropics/claude-code/issues/84352) | \[BUG\] CVP-approved Claude.ai organization still receives cyber safeguard blocks in Claude Code | federicolopeza | OPEN | 19 (👍 19) | 108 | 2026-08-16 | 2026-08-06 | — |
| [#34556](https://github.com/anthropics/claude-code/issues/34556) | Feature Request: Persistent Memory Across Context Compactions (59 compactions, built our own) | Haustorium12 | OPEN | 6 (👍 6) | 83 | 2026-08-16 | 2026-03-15 | enhancement, memory |
| [#87123](https://github.com/anthropics/claude-code/issues/87123) | Add a setting in config to enable or disable screen reader mode (AXScreenReader) | nromey | OPEN | 1 (👍 1) | 1 | 2026-08-16 | 2026-08-16 | area:a11y, area:tui, enhancement |
| [#86275](https://github.com/anthropics/claude-code/issues/86275) | Windows desktop app: cross-session send\_message silently fails (reports success, never delivered) after runtime 2.1.222→2.1.227 auto-update | Heeyoung-Ahn | OPEN | 7 (👍 7) | 11 | 2026-08-16 | 2026-08-13 | area:desktop, bug, has repro, platform:windows |
| [#86629](https://github.com/anthropics/claude-code/issues/86629) | Cross-session send\_message queues and renders in target session UI but is never injected into its context (regression v2.1.222 -&gt; v2.1.227, Windows desktop) | NineofP9 | OPEN | 0 | 5 | 2026-08-16 | 2026-08-14 | area:agents, area:desktop, bug, has repro, platform:windows, regression |
| [#72495](https://github.com/anthropics/claude-code/issues/72495) | \[BUG\] Prompt suggestions silently suppressed whenever the client-derived rate-limit status is allowed\_warning — strict-equality gate in Vxy | inth3shadows | OPEN | 0 | 5 | 2026-08-16 | 2026-06-30 | area:tui, bug, has repro, platform:linux, platform:macos, platform:windows |
