...
| [#18435](https://github.com/anthropics/claude-code/issues/18435) | \[FEATURE\] Add the ability to manage multiple Claude accounts within the Claude Desktop app with easy switching between profiles. | Agentic-Marketer | OPEN | 829 (👍 729 · ❤️ 49 · 🚀 36 · 👀 15) | 166 | 2026-08-14 | 2026-01-15 | area:auth, area:ide, enhancement |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#83835](https://github.com/anthropics/claude-code/issues/83835) | \[BUG\] Desktop (Windows): GPU process crashes with identical exitCode 101457950 (0x060C201E) on both NVIDIA and Intel adapters | osmanerendgn | CLOSED / DUPLICATE | 0 | 4 | 2026-08-15 | 2026-08-04 | bug, duplicate |
| [#83893](https://github.com/anthropics/claude-code/issues/83893) | \[BUG\] Windows desktop: failed RepairAppRegistration marks MSIX package Modified, NeedsRemediation — app unlaunchable within seconds of use | vanderburgh-house | CLOSED / DUPLICATE | 0 | 2 | 2026-08-15 | 2026-08-04 | bug, duplicate |
| [#83695](https://github.com/anthropics/claude-code/issues/83695) | /insights never populates facets/ cache — at\_a\_glance stays "\_No insights generated\_" across repeated runs | kyleh-fwsayer | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-04 | duplicate |
| [#84441](https://github.com/anthropics/claude-code/issues/84441) | \[Feature Request\] Support clipboard paste (Ctrl+V) for images in Windows Terminal | flecamos | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-06 | duplicate |
| [#84798](https://github.com/anthropics/claude-code/issues/84798) | \[Bug\] claude.ai plugin OAuth falls back to retired /authorize endpoint for Claude design MCP | hrougier | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-07 | duplicate |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#83264](https://github.com/anthropics/claude-code/issues/83264) | Plugin version resolution walks out of a non-git marketplace dir and records the user's own repo HEAD | 0rangeSeaW0lf | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-02 | duplicate |
| [#83156](https://github.com/anthropics/claude-code/issues/83156) | Chrome extension leaves orphaned tab groups when a session ends without closing its tabs | contardm | CLOSED / DUPLICATE | 0 | 2 | 2026-08-15 | 2026-08-01 | duplicate |
| [#83352](https://github.com/anthropics/claude-code/issues/83352) | Respect XDG\_CONFIG\_HOME for config directory | wrp | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-02 | duplicate |
| [#83659](https://github.com/anthropics/claude-code/issues/83659) | Customize/disable the turn-duration verb, or derive it from spinnerVerbs | devinnasar | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-03 | duplicate |
| [#83669](https://github.com/anthropics/claude-code/issues/83669) | Ultrareview consumed a free run but produced zero output (orchestrator crashed) | Spektra21 | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-03 | duplicate |
| [#84467](https://github.com/anthropics/claude-code/issues/84467) | \[Bug\] Model unexpectedly downgrading to lower-tier models during normal operations | Not-Chur-Architect | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-06 | duplicate |
| [#84943](https://github.com/anthropics/claude-code/issues/84943) | \[BUG\] iOS Simulator panel reports 'Xcode is installed but not selected' on Xcode 26.6 / macOS 26.5 despite correct xcode-select | AbbyFitz2-droid | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-07 | duplicate |
| [#85891](https://github.com/anthropics/claude-code/issues/85891) | \[BUG\] Claude Desktop (Windows 11): main window stays always-on-top of other applications, with no setting to disable it | kylealty-boop | OPEN | 4 (👍 4) | 7 | 2026-08-15 | 2026-08-11 | invalid |
| [#84639](https://github.com/anthropics/claude-code/issues/84639) | ugrep grep shim breaks when CLAUDE\_CODE\_EXECPATH is a dynamic loader (Termux glibc): '-G: cannot open shared object file', exit 127 | pandarun | CLOSED / DUPLICATE | 0 | 3 | 2026-08-15 | 2026-08-06 | duplicate |
| [#84736](https://github.com/anthropics/claude-code/issues/84736) | \[MODEL\] | narayaana | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-07 | duplicate, model |
| [#83259](https://github.com/anthropics/claude-code/issues/83259) | \[BUG\] Native installer binary crashes with SIGILL (Illegal instruction) on non-AVX2 CPUs — request non-AVX2 build | 0xOpCode | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-02 | bug, duplicate |
| [#84885](https://github.com/anthropics/claude-code/issues/84885) | \[BUG\] Missing HCS services: vfpext on Windows 11 Pro after enabling Hyper-V | abdallahselim228-crypto | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-07 | bug, duplicate |
| [#83471](https://github.com/anthropics/claude-code/issues/83471) | chrome-native-host crashes on every invocation (Windows, ERR\_INVALID\_ARG\_TYPE on named pipe listen) | PulseCheckAI | CLOSED / DUPLICATE | 0 | 2 | 2026-08-15 | 2026-08-03 | duplicate |
| [#86503](https://github.com/anthropics/claude-code/issues/86503) | \[BUG\] Billing: €34.55 account credit from Pro→Max plan change never applied or refunded (EU customer) | ReUsingFactory | OPEN | 0 | 1 | 2026-08-15 | 2026-08-13 | invalid |
| [#83544](https://github.com/anthropics/claude-code/issues/83544) | Statusline payload reports wrong effort level after /effort change | kawallac | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-03 | duplicate |
| [#83725](https://github.com/anthropics/claude-code/issues/83725) | \[Feature Request\] Reduce response verbosity to match Cursor's conciseness | ZachFu1091 | CLOSED / DUPLICATE | 1 (👍 1) | 1 | 2026-08-15 | 2026-08-04 | duplicate |
| [#83126](https://github.com/anthropics/claude-code/issues/83126) | Assistant text block silently lost (not rendered and absent from ctrl+o transcript) when followed by AskUserQuestion after a mid-turn user message | hdds-team | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-01 | duplicate |
| [#84652](https://github.com/anthropics/claude-code/issues/84652) | file\_upload tool fails with "expected array, received undefined" for paths — persists after extension update and full reinstall-equivalent reset | warrensloane | CLOSED / DUPLICATE | 1 (👍 1) | 2 | 2026-08-15 | 2026-08-06 | duplicate |
| [#84063](https://github.com/anthropics/claude-code/issues/84063) | \[Bug\] WSL path in workspace folder causes broken relative path resolution on Windows | workk94 | CLOSED / DUPLICATE | 0 | 1 | 2026-08-15 | 2026-08-05 | duplicate |
| [#84856](https://github.com/anthropics/claude-code/issues/84856) | ExitWorktree's safety check false-positives after every squash-merge — ancestry is the wrong predicate | rflcrz | CLOSED / DUPLICATE | 1 (👍 1) | 2 | 2026-08-15 | 2026-08-07 | duplicate |
