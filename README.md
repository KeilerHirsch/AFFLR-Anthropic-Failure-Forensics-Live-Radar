...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87058](https://github.com/anthropics/claude-code/issues/87058) | CLI crashes with SIGABRT on \`HTTP Client\` thread (4x in 32h, v2.1.232 &amp; v2.1.233) | jerneumann | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:core, area:networking, duplicate, platform:macos |
| [#73506](https://github.com/anthropics/claude-code/issues/73506) | \[Bug\] Anthropic API Error: Server rate limiting on requests | Sahasrara | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-02 | api:anthropic, area:api, duplicate, external, platform:macos |
| [#73388](https://github.com/anthropics/claude-code/issues/73388) | Agent-mode session silently drops mid-turn after tool\_result on unattended Mac (WarmLifecycle idle\_timeout suspected) | Jaxxdprime | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-02 | area:desktop, bug, platform:macos |
| [#85702](https://github.com/anthropics/claude-code/issues/85702) | \[FEATURE\] Programmatic access to scheduled routine (cloud session) transcripts via API | agent-ptolemy | OPEN | 0 | 1 | 2026-08-16 | 2026-08-11 | area:api, area:routines, enhancement |
| [#87057](https://github.com/anthropics/claude-code/issues/87057) | \[Bug\] TODO tasks lost during execution | duc01226 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | bug, needs-repro, platform:windows |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#73309](https://github.com/anthropics/claude-code/issues/73309) | SSH/Remote-Tools connection to Synology NAS fails: "Failed to upload file: No such file" | lukas-crafts | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-02 | area:tools, bug, platform:macos |
| [#63685](https://github.com/anthropics/claude-code/issues/63685) | Your organization has disabled Claude subscription access for Claude Code · Use an Anthropic API key instead, or ask your admin to enable access | rapha-cunha | OPEN | 0 | 5 | 2026-08-16 | 2026-05-29 | area:auth, platform:macos, question |
| [#62462](https://github.com/anthropics/claude-code/issues/62462) | Cannot copy text from Claude responses in interactive TUI (GNOME Terminal, Ubuntu 24.04) | Chawer1 | OPEN | 11 (👍 11) | 11 | 2026-08-16 | 2026-05-26 | — |
| [#87056](https://github.com/anthropics/claude-code/issues/87056) | Concurrent editing: agent file edits race user's editor autosave (need collision detection / merge) | psuechting | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:tools, enhancement, platform:windows |
| [#73003](https://github.com/anthropics/claude-code/issues/73003) | \[Feature Request\] Refine content safeguards to reduce false positives on legitimate coding work | fwddeploy | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-01 | area:model, enhancement, platform:macos |
| [#87055](https://github.com/anthropics/claude-code/issues/87055) | \[BUG\] Background Bash task's process group is SIGKILLed mid-run when the command spawns a daemonizing CLI (cursor-agent) — and reported as completed (exit code 0) | 28peso | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:bash, bug, has repro, platform:macos |
| [#72546](https://github.com/anthropics/claude-code/issues/72546) | \[Bug\] Anthropic API Error: Server Rate Limiting (Temporary Request Limit) | Sahasrara | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-06-30 | api:anthropic, area:api, duplicate, external, platform:macos |
| [#87054](https://github.com/anthropics/claude-code/issues/87054) | I appreciate you sharing the context, but I'm not able to access external Request IDs or see the specific bug report you're referencing.   To generate an appropriate GitHub issue title, I would need:  1. \*\*The actual error message or problem\*\* you're exper | Jahvis | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | bug, needs-info, platform:macos |
| [#66495](https://github.com/anthropics/claude-code/issues/66495) | \[BUG\] Desktop — Progressive Renderer Degradation on Windows 11 / NVIDIA G-Sync | davidm4164-web | CLOSED / COMPLETED | 0 | 4 | 2026-08-16 | 2026-06-09 | area:desktop, bug, invalid, platform:windows |
| [#87053](https://github.com/anthropics/claude-code/issues/87053) | \[FEATURE\] Non-intrusive prompts — stop stealing focus from active typing (52 related reports, consolidated) | agur | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:ide, area:permissions, area:tui, enhancement, user-experience |
| [#24798](https://github.com/anthropics/claude-code/issues/24798) | Inter-session communication for multi-Claude workflows | hmcg001 | OPEN | 21 (👍 21) | 78 | 2026-08-16 | 2026-02-10 | area:core, area:tui, enhancement |
| [#87052](https://github.com/anthropics/claude-code/issues/87052) | Desktop app GPU process crashes (exit code 101457950) when Browser pane renders a page with a Cloudflare Turnstile widget | tjborriello | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:desktop, duplicate, has repro, platform:windows |
...
| [#85840](https://github.com/anthropics/claude-code/issues/85840) | \[BUG\] Windows: CoworkVMService can never arm its own recovery actions ("Access is denied" at every start) — service death becomes a silent claude.exe hang with no crash dump (root cause of #59794 and #66849, both closed stale) | Xotvs | OPEN | 0 | 2 | 2026-08-16 | 2026-08-11 | area:cowork, area:desktop, bug, has repro, platform:windows |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 5 (👍 5) | 25 | 2026-08-16 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#87051](https://github.com/anthropics/claude-code/issues/87051) | \[BUG\] Cloud workspace session persists its /sessions mount path into core.worktree of the synced repo's shared config, breaking local worktree creation | erikreinert | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:agents, area:core, bug, has repro, platform:macos |
| [#74990](https://github.com/anthropics/claude-code/issues/74990) | \[BUG\] /compact and auto-compaction drop entire Available skills system-reminder; /reload-skills recovers with "no changes" | HappyOnigiri | OPEN | 3 (👍 3) | 6 | 2026-08-16 | 2026-07-06 | area:core, area:skills, bug, documentation, has repro, platform:macos, reproduced |
| [#85422](https://github.com/anthropics/claude-code/issues/85422) | \[FEATURE\] Token-burn circuit breaker: runtime-enforced spend caps with per-source attribution (hooks, plugins, subagents), not just warnings | tonydehnke | OPEN | 0 | 3 | 2026-08-16 | 2026-08-10 | — |
| [#75757](https://github.com/anthropics/claude-code/issues/75757) | \[Bug\] Subagents billed after monthly spend limit exceeded; false clean review result on agent failures | dmsakamoto | OPEN | 0 | 6 | 2026-08-16 | 2026-07-08 | area:agents, area:cost, bug, platform:macos |
| [#77819](https://github.com/anthropics/claude-code/issues/77819) | \[BUG\] Fable 5 on Max: "You've hit your monthly spend limit" despite Unlimited spend limit and meters at 5% session / 41% weekly | ciaran-finnegan | OPEN | 0 | 4 | 2026-08-16 | 2026-07-15 | area:cost, bug, platform:macos |
