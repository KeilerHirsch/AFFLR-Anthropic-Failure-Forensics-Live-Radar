...
| Issue | Title | State | Signal | Updated | Created | Labels |
|---:|---|---|---|---|---|---|
| [#87818](https://github.com/anthropics/claude-code/issues/87818) | Desktop app can spawn a duplicate live session on terminal restart (Remote Control); window lifecycle undocumented | OPEN | security / trust boundary | 2026-08-19 | 2026-08-19 | — |
