...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86908](https://github.com/anthropics/claude-code/issues/86908) | \[BUG\] Resumed cloud routine session: connector tools de-registered and never restored (the MCP half of #81822) | lamego | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:mcp, area:routines, bug, has repro, platform:web |
| [#86907](https://github.com/anthropics/claude-code/issues/86907) | permissions.defaultMode: "bypassPermissions" doesn't prevent a fresh session from starting in "manual mode" — Scheduled Tasks still hit Allow prompts | quyetnguyen-stack | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:permissions, bug, platform:windows |
| [#86909](https://github.com/anthropics/claude-code/issues/86909) | \[BUG\] Model searches connector directory, then reports it as having searched the loaded tool index | lamego | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | — |
| [#72622](https://github.com/anthropics/claude-code/issues/72622) | \[BUG\] Claude Desktop (Windows): system-tray icon invisible when app theme differs from the Windows taskbar mode — wrong-contrast glyph selected (mirror of #65343) | ascetum | OPEN | 2 (👍 2) | 3 | 2026-08-15 | 2026-06-30 | invalid |
| [#86906](https://github.com/anthropics/claude-code/issues/86906) | \[MODEL\] Claude advised creating a 2nd account for billing, triggering automated suspension | YeeZhiLi | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | invalid |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86905](https://github.com/anthropics/claude-code/issues/86905) | tool admits rules claude.md is only bakground noicse nothing that matters | andreapeterfly-prog | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:model, bug, needs-repro, platform:macos |
| [#86904](https://github.com/anthropics/claude-code/issues/86904) | \[BUG\] Auto mode missing from permission mode picker on Fable 5 (VS Code extension, Windows) | dan-1492 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:permissions, bug, has repro, platform:vscode, platform:windows |
| [#63930](https://github.com/anthropics/claude-code/issues/63930) | Prompt cache fully re-created after turns with many parallel tool calls (cache\_read collapses to system+tools floor) — ~74% of cache writes wasted on Opus 4.8 / v2.1.15x | omrikais | OPEN | 6 (👍 6) | 11 | 2026-08-15 | 2026-05-30 | api:anthropic, area:core, area:cost, bug, has repro, platform:macos |
| [#86903](https://github.com/anthropics/claude-code/issues/86903) | \[BUG\] Claude Code Remote: fired \`send\_later\` one-shot Routines keep a live-looking \`next\_run\_at\` +24h and can fire again | mikelward | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:routines, bug |
| [#86895](https://github.com/anthropics/claude-code/issues/86895) | \[BUG\] Cowork local mode: resume is passed a session ID that never existed — the session file is intact on disk (Linux, 1.30096.1) | AlphAquilA | OPEN | 0 | 2 | 2026-08-15 | 2026-08-15 | area:cowork, bug, has repro, platform:linux |
| [#41015](https://github.com/anthropics/claude-code/issues/41015) | \[FEATURE\] Allow configuring or disabling the URL Handler app install location (currently hardcoded to ~/Applications/) | acbjdbyler | OPEN | 36 (👍 36) | 10 | 2026-08-15 | 2026-03-30 | area:installation, enhancement, platform:macos |
| [#86902](https://github.com/anthropics/claude-code/issues/86902) | \[Bug\] Unclear error messaging for safety flagged operations | joelvogt | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:model, bug, needs-repro, platform:macos |
