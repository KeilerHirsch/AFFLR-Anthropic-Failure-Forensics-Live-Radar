...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#84352](https://github.com/anthropics/claude-code/issues/84352) | \[BUG\] CVP-approved Claude.ai organization still receives cyber safeguard blocks in Claude Code | federicolopeza | OPEN | 12 (👍 12) | 79 | 2026-08-12 | 2026-08-06 | — |
...
| [#86228](https://github.com/anthropics/claude-code/issues/86228) | Desktop Browser pane: allow user-approved local hostnames (hosts-file aliases) as trusted preview origins — currently all subresources blocked with ERR\_BLOCKED\_BY\_CLIENT | berson-andrew | OPEN | 0 | 0 | 2026-08-12 | 2026-08-12 | area:desktop, area:security, enhancement, platform:windows |
| [#72239](https://github.com/anthropics/claude-code/issues/72239) | \[FEATURE\] Honour MCP Annotations.Audience on tool-result content blocks | carrotRakko | OPEN | 1 (👍 1) | 3 | 2026-08-12 | 2026-06-29 | area:mcp, area:tui, enhancement |
| [#77927](https://github.com/anthropics/claude-code/issues/77927) | \[BUG\] Desktop "Add marketplace" GUI fails with generic "Failed to add marketplace" (MARKETPLACE\_ERROR:UNKNOWN) — git clone stalls in non-interactive SSH, killed at ~60s timeout | ITSalt | OPEN | 0 | 1 | 2026-08-12 | 2026-07-15 | area:desktop, area:plugins, bug, platform:windows |
| [#76882](https://github.com/anthropics/claude-code/issues/76882) | plugin marketplace update fetches new version but doesn't update installed\_plugins.json | jfenal | OPEN | 1 (👍 1) | 3 | 2026-08-12 | 2026-07-12 | area:plugins, bug, has repro, platform:linux |
| [#68287](https://github.com/anthropics/claude-code/issues/68287) | \[BUG\] Max plan: Opus 4.8 only shows 256k context, 1M option missing in model picker | ericlee0121 | CLOSED / NOT\_PLANNED | 1 (👍 1) | 7 | 2026-08-12 | 2026-06-13 | area:model, bug, platform:windows, stale |
| [#69109](https://github.com/anthropics/claude-code/issues/69109) | \[FEATURE\] Opus 4.8 (1M context) model option disappeared from the model picker | bencomputer-vn | CLOSED / NOT\_PLANNED | 3 (👍 3) | 6 | 2026-08-12 | 2026-06-17 | area:desktop, area:model, bug, platform:windows, stale |
| [#40173](https://github.com/anthropics/claude-code/issues/40173) | Claude-in-Chrome: Server-side domain blocking breaks legitimate business automation | scubashack808 | CLOSED / NOT\_PLANNED | 7 (👍 7) | 12 | 2026-08-12 | 2026-03-28 | area:browser-extension, area:chrome, enhancement, platform:macos, stale |
| [#71720](https://github.com/anthropics/claude-code/issues/71720) | Feature request: show per-message timestamps in the terminal conversation UI | KevinVanDriel-Perpetuals | CLOSED / NOT\_PLANNED | 3 (👍 3) | 1 | 2026-08-12 | 2026-06-27 | area:tui, duplicate, enhancement, stale |
| [#71718](https://github.com/anthropics/claude-code/issues/71718) | \[BUG\] Cannot copy text correctly from Code tab (Remote Control session) on mobile app | sergiomtzmoz | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | area:ui, bug, platform:ios, stale |
| [#71719](https://github.com/anthropics/claude-code/issues/71719) | \[BUG\] SPB\_DATA installation failure due to Cadence HOME environment variable | PowiHugh | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-27 | area:installation, bug, has repro, platform:windows, stale |
| [#63055](https://github.com/anthropics/claude-code/issues/63055) | \[BUG\] RemoteTrigger create/update returns HTTP 400 with circular error: "event\_type is required" / "unknown field event\_type" | jacobforbes95 | CLOSED / NOT\_PLANNED | 1 (👍 1) | 2 | 2026-08-12 | 2026-05-28 | api:anthropic, area:routines, bug, has repro, platform:macos, stale |
| [#71649](https://github.com/anthropics/claude-code/issues/71649) | claude.ai managed connector (claudeai-proxy) can't be re-attached from CLI — claudeAiOauth never re-minted, no recovery path | gblush | CLOSED / NOT\_PLANNED | 0 | 2 | 2026-08-12 | 2026-06-26 | area:auth, area:mcp, bug, platform:macos, stale |
| [#71707](https://github.com/anthropics/claude-code/issues/71707) | \[Feature Request\] Display exact allowlist command format when requesting tool permission | ethanpschoen | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | area:permissions, enhancement, stale |
| [#71481](https://github.com/anthropics/claude-code/issues/71481) | \[BUG\] Silent default model upgrade to Opus 4.7 caused $506 in unexpected charges over 6 days | ToruCHIKAZAWA | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-12 | 2026-06-26 | area:cost, area:model, bug, platform:macos, stale |
| [#71705](https://github.com/anthropics/claude-code/issues/71705) | \[Bug\] Anthropic API Error: Server Rate Limiting During Normal Usage | Sahasrara | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | api:anthropic, area:api, duplicate, external, platform:macos, stale |
| [#71704](https://github.com/anthropics/claude-code/issues/71704) | \[Bug\] Anthropic API Error: Server Rate Limiting on Valid Requests | Sahasrara | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | area:api, bug, external, platform:macos, stale |
| [#71706](https://github.com/anthropics/claude-code/issues/71706) | \[Bug\] Anthropic API Error: Server Rate Limiting (Request Throttling) | Sahasrara | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | api:anthropic, area:api, duplicate, external, platform:macos, stale |
| [#71703](https://github.com/anthropics/claude-code/issues/71703) | \[Bug\] Anthropic API Error: Server rate limiting (temporary request throttling) | Sahasrara | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-12 | 2026-06-26 | api:anthropic, area:api, duplicate, external, platform:macos, stale |
| [#63754](https://github.com/anthropics/claude-code/issues/63754) | \[BUG\] Cowork — account enrolled in two A/B variants (\`testfoo\` + \`0526\`) causing skill misfires + connector failure; \`ENABLE\_TOOL\_SEARCH\` mismatch | seanoulashin | CLOSED / NOT\_PLANNED | 0 | 7 | 2026-08-12 | 2026-05-29 | area:cowork, area:skills, bug, platform:macos, stale |
