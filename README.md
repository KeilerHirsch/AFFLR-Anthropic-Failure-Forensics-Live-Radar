...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#71437](https://github.com/anthropics/claude-code/issues/71437) | \[BUG\] \`/clear\` in Claude Desktop resets current session in-place instead of creating a new session | squatto | OPEN | 2 (👍 2) | 4 | 2026-08-14 | 2026-06-25 | area:desktop, bug, has repro, platform:macos, stale |
| [#82049](https://github.com/anthropics/claude-code/issues/82049) | Claude.ai sign-in (magic link) emails delayed 2-5 minutes since mid-July 2026 | leojianliu-dot | OPEN | 5 (👍 5) | 9 | 2026-08-14 | 2026-07-28 | — |
| [#86461](https://github.com/anthropics/claude-code/issues/86461) | \[FEATURE\] Reviewable draft-message relay between Home chat threads and between Home chat threads and Code sessions | lennig | OPEN | 0 | 0 | 2026-08-14 | 2026-08-13 | area:desktop, enhancement, platform:macos |
| [#70648](https://github.com/anthropics/claude-code/issues/70648) | \[BUG\] AskUserQuestion must be answered multiple times after idle on Desktop/cloud sessions | Rendalf | CLOSED / DUPLICATE | 4 (👍 4) | 5 | 2026-08-14 | 2026-06-24 | duplicate |
| [#86778](https://github.com/anthropics/claude-code/issues/86778) | /auto-mode-setup hangs after printing 'Gathering data and drafting your auto-mode setup; back soon' | brianleach | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:cli, bug, platform:macos |
...
| [#86777](https://github.com/anthropics/claude-code/issues/86777) | \[Bug\] Left-Arrow keypress partially restarts workflow, orphaning live agents and re-executing completed ones | YasserRabee | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:agents, area:tui, bug, data-loss, platform:linux |
| [#86776](https://github.com/anthropics/claude-code/issues/86776) | Fable 5 safeguards false-positive on camera-protocol dev and public court/registry browser automation — ~20 silent sticky switches to Opus 4.8 in 4 weeks | eddieboomoasis | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:model, bug, platform:macos |
| [#86775](https://github.com/anthropics/claude-code/issues/86775) | \[BUG\] Background sessions never receive SIGWINCH — TUI never reflows on terminal resize | zhengyu-yang | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:agent-view, area:tui, bug, has repro, platform:linux |
| [#86774](https://github.com/anthropics/claude-code/issues/86774) | Conversation tab title generated in the wrong language (French title for a Czech conversation) | lucielavickova-tesena | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:ide, bug, platform:vscode, platform:windows |
| [#86439](https://github.com/anthropics/claude-code/issues/86439) | \[BUG\] \`/goal\` and \`/goal clear\` report "No goal set" after a met/failed verdict while the Stop hook stays armed | CaptainException | CLOSED / COMPLETED | 0 | 0 | 2026-08-14 | 2026-08-13 | area:core, area:hooks, bug, has repro, platform:vscode, platform:windows |
| [#86773](https://github.com/anthropics/claude-code/issues/86773) | \[Bug\] Auto mode unresponsive with excessive token consumption | waldomccoy-a11y | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:tui, bug, platform:windows |
| [#67992](https://github.com/anthropics/claude-code/issues/67992) | \[BUG\] Scheduled-task sessions surface inconsistently in Desktop sidebar: sometimes as unmarked ordinary chats, sometimes not at all; no badge, no running indicator, no reliable way to find them | eddyplolz | OPEN | 2 (👍 2) | 2 | 2026-08-14 | 2026-06-12 | area:desktop, area:routines, bug, platform:windows |
| [#71787](https://github.com/anthropics/claude-code/issues/71787) | \[FEATURE\] Add visual distinction between Chat Projects and Cowork Projects in sidebar | BerniDarko | OPEN | 0 | 2 | 2026-08-14 | 2026-06-27 | area:cowork, area:desktop, enhancement |
| [#86772](https://github.com/anthropics/claude-code/issues/86772) | Desktop app: embedded browser panel silently drops custom-scheme deep links (obsidian:// etc.) | whalemenace | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | invalid |
| [#86771](https://github.com/anthropics/claude-code/issues/86771) | \[BUG\] Google Drive connector requests drive.readonly scope in addition to drive.file, granting full-Drive read access despite "specific files only" consent UI | lennig | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:cowork, area:security, bug |
...
| [#86770](https://github.com/anthropics/claude-code/issues/86770) | \[Bug\] Anthropic API Error: Content flagged by safeguards, reconnection fails | dibyendubiswasburman | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:api, bug, platform:macos |
| [#86769](https://github.com/anthropics/claude-code/issues/86769) | \[Bug\] Incomplete scan operation - "conitine the scan" command not recognized | dibyendubiswasburman | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | bug, needs-info, needs-repro, platform:macos |
| [#74902](https://github.com/anthropics/claude-code/issues/74902) | \[BUG\] claude-in-chrome MCP can't distinguish two Chrome profiles — \`list\_connected\_browsers\` returns unstable generic "Browser 1/2" names, forcing constant disambiguation and wrong-profile risk | nlstmitchell | OPEN | 2 (👍 2) | 4 | 2026-08-14 | 2026-07-06 | area:chrome, bug, platform:windows |
...
| [#78115](https://github.com/anthropics/claude-code/issues/78115) | Group by PR status removed from Code tab sidebar (macOS desktop app, v1.21459.3) | joncass | OPEN | 1 (👍 1) | 2 | 2026-08-14 | 2026-07-16 | area:desktop, area:ui, bug, platform:macos, regression |
| [#86768](https://github.com/anthropics/claude-code/issues/86768) | \[BUG\] Desktop sidebar Group by State: row dot and bucket derive from disjoint inputs, so Completed sessions render the pulsing Working dot | karlkfi | OPEN | 0 | 1 | 2026-08-14 | 2026-08-14 | area:desktop, area:ui, bug, has repro, platform:macos |
| [#75757](https://github.com/anthropics/claude-code/issues/75757) | \[Bug\] Subagents billed after monthly spend limit exceeded; false clean review result on agent failures | dmsakamoto | OPEN | 0 | 5 | 2026-08-14 | 2026-07-08 | area:agents, area:cost, bug, platform:macos |
