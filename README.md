...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87157](https://github.com/anthropics/claude-code/issues/87157) | \[BUG\] Claude Desktop (Windows) crashes when opening generated web page preview — infinite render loop in EpitaxyFramePage + EventEmitter listener leak | venificus | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | bug |
| [#71726](https://github.com/anthropics/claude-code/issues/71726) | \[FEATURE\] Desktop app: inject queued messages mid-task between tool calls (CLI steering parity) | mar-cun | OPEN | 20 (👍 20) | 13 | 2026-08-16 | 2026-06-27 | area:desktop, duplicate |
| [#87156](https://github.com/anthropics/claude-code/issues/87156) | \[Bug\] Fork on completed /btw response re-submits original prompt instead of continuing session | dwaltrip | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:agents, area:tui, bug, platform:macos |
| [#86629](https://github.com/anthropics/claude-code/issues/86629) | Cross-session send\_message queues and renders in target session UI but is never injected into its context (regression v2.1.222 -&gt; v2.1.227, Windows desktop) | NineofP9 | OPEN | 0 | 4 | 2026-08-16 | 2026-08-14 | area:agents, area:desktop, bug, has repro, platform:windows, regression |
| [#83523](https://github.com/anthropics/claude-code/issues/83523) | \[Bug\] Push notifications fail to deliver to Android device despite tool reporting success | juitindev | OPEN | 0 | 1 | 2026-08-16 | 2026-08-03 | — |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87155](https://github.com/anthropics/claude-code/issues/87155) | Claude Desktop tray icons are indistinguishable when multiple instances are running | wshallwshall | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | invalid |
| [#87115](https://github.com/anthropics/claude-code/issues/87115) | \[FEATURE\] Allow macOS computer use to operate one app without taking over the user's workstation | nikkundra | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:desktop, enhancement, platform:macos |
| [#87154](https://github.com/anthropics/claude-code/issues/87154) | Cross-machine session directory never populates: ListAgents shows only local sessions despite both machines being RC-connected (v2.1.233) | alazir4 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:agents, bug, platform:macos |
| [#86014](https://github.com/anthropics/claude-code/issues/86014) | \[BUG\] Cross-session send\_message reports success but message is never delivered (stuck loading, 0/4 delivery) | lilysttail | OPEN | 3 (👍 3) | 7 | 2026-08-16 | 2026-08-12 | area:agents, bug, platform:windows |
| [#86952](https://github.com/anthropics/claude-code/issues/86952) | \[BUG\] Cleanup sweep calls rmdir on every directory under ~/.claude/projects, deleting foreign empty directories and ignoring cleanupPeriodDays | YakGravity | OPEN | 0 | 1 | 2026-08-16 | 2026-08-15 | area:core, bug, has repro, platform:linux |
| [#34556](https://github.com/anthropics/claude-code/issues/34556) | Feature Request: Persistent Memory Across Context Compactions (59 compactions, built our own) | Haustorium12 | OPEN | 6 (👍 6) | 79 | 2026-08-16 | 2026-03-15 | enhancement, memory |
| [#87110](https://github.com/anthropics/claude-code/issues/87110) | \[BUG\] send\_message\` (ccd\_session\_mgmt) renders in the recipient's UI but is never injected — regression between app 2.1.222 and 2.1.227 | ContactNik108 | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | area:agents, area:desktop, bug, duplicate, platform:windows, regression |
| [#87153](https://github.com/anthropics/claude-code/issues/87153) | Denial messages don't say which permission rule or settings file fired | cortrothems-ai | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:permissions, enhancement |
| [#87152](https://github.com/anthropics/claude-code/issues/87152) | \[Feature Request\] Implement context reset or conversation pruning for improved performance over long interactions | javicar31 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:core, enhancement, platform:macos |
| [#86603](https://github.com/anthropics/claude-code/issues/86603) | \[BUG\] send\_message reports success on native Windows where cross-session messaging is not offered — no inbox socket bound, nothing delivered, caller cannot tell (worked on this machine until 2026-08-11) | Neverbet | OPEN | 0 | 5 | 2026-08-16 | 2026-08-14 | area:agents, area:desktop, bug, has repro, platform:windows, regression |
| [#84689](https://github.com/anthropics/claude-code/issues/84689) | \[BUG\] CVP approved org still blocked by cyber safeguards — org ID confirmed matching, appeal form shows no fields | RenzyXSec | OPEN | 0 | 10 | 2026-08-16 | 2026-08-07 | bug |
| [#84530](https://github.com/anthropics/claude-code/issues/84530) | \[BUG\] 2.1.222 escalates #82966 to ordinary sessions: worktree isolation refuses every \`source\`/\`.\` via an interpreter denylist, with no opt-out | brady-eaiti | OPEN | 2 (👍 2) | 7 | 2026-08-16 | 2026-08-06 | reproduced |
| [#85021](https://github.com/anthropics/claude-code/issues/85021) | Permission-mode indicators use U+23F5 (⏵), a codepoint no common monospace font ships — replace with U+25B6 (▶) | voyager | OPEN | 1 (👍 1) | 1 | 2026-08-16 | 2026-08-08 | — |
| [#87151](https://github.com/anthropics/claude-code/issues/87151) | Feature request: progress indicator for long-running background tasks (/code-review, background agents) | mwoodruff0814 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:agent-view, area:tui, enhancement |
| [#54394](https://github.com/anthropics/claude-code/issues/54394) | \[BUG\] v2.1.117 embedded ugrep wrapper amplifies regex backtracking from grep-process-OOM into V8-heap-OOM (8 GB ceiling) — host freezes on WSL2 | dowdys | OPEN | 4 (👍 4) | 30 | 2026-08-16 | 2026-04-28 | area:bash, bug, has repro, perf:memory, platform:wsl |
| [#87150](https://github.com/anthropics/claude-code/issues/87150) | Startup config should be processed before first user prompt, not after | jaclu | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:core, enhancement |
| [#24962](https://github.com/anthropics/claude-code/issues/24962) | Cowork VM fails on Windows 11 Home: wrong DNS config, missing sessiondata.vhdx, no NAT | kerinzeebart | OPEN | 5 (👍 5) | 16 | 2026-08-16 | 2026-02-11 | area:core, bug, has repro, platform:windows |
| [#36151](https://github.com/anthropics/claude-code/issues/36151) | \[FEATURE\] Multi-account switching in Claude Mobile app without shared email | CorneAussems | OPEN | 806 (👍 593 · ❤️ 172 · 🚀 41) | 154 | 2026-08-16 | 2026-03-19 | invalid |
| [#87149](https://github.com/anthropics/claude-code/issues/87149) | claude auto-mode critique returns "No critique was generated" for a large autoMode block; works with a small one | RandScullard | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:cli, bug, platform:windows |
| [#87148](https://github.com/anthropics/claude-code/issues/87148) | \[Feature Request\] Add security policy documentation and usage restrictions | rubenmarcuspaschoarelli | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:docs, area:security, enhancement, platform:windows |
