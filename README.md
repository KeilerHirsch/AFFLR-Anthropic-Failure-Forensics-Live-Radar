...
| [#80123](https://github.com/anthropics/claude-code/issues/80123) | \[Bug\] Agent view uses stale terminal width after window resize on Windows (ConPTY) | Adolys | OPEN | 2 (👍 2) | 2 | 2026-08-14 | 2026-07-22 | — |
| [#84258](https://github.com/anthropics/claude-code/issues/84258) | \[BUG\] Worktree isolation hard-blocks ALL \`git -C &lt;main-checkout&gt;\` calls — even read-only, even after a PreToolUse hook explicitly approves it | fluidsonic | OPEN | 8 (👍 8) | 3 | 2026-08-14 | 2026-08-05 | bug |
| [#24798](https://github.com/anthropics/claude-code/issues/24798) | Inter-session communication for multi-Claude workflows | hmcg001 | OPEN | 21 (👍 21) | 67 | 2026-08-14 | 2026-02-10 | area:core, area:tui, enhancement |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#76187](https://github.com/anthropics/claude-code/issues/76187) | \[BUG\] Cowork (Windows): project context folders never mount in new sessions; Add-folder dialog cannot confirm — reproduced on two machines after latest update | jwishon | OPEN | 1 (👍 1) | 11 | 2026-08-14 | 2026-07-09 | area:cowork, bug, has repro, platform:windows, regression |
| [#86757](https://github.com/anthropics/claude-code/issues/86757) | \[BUG\] macOS: iOS Simulator sidecar aborts on every call — sandbox blocks its per-bundle-id Metal shader cache dir | samratjp | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:sandbox, bug, has repro, platform:macos |
| [#86756](https://github.com/anthropics/claude-code/issues/86756) | \[BUG\] Windows: one broken MCP server entry in claude\_desktop\_config.json silently kills every cold session start (no turn, worker exits) — should degrade gracefully | panteliskopsias | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:desktop, area:mcp, bug, platform:windows |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 4 (👍 4) | 19 | 2026-08-14 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#86755](https://github.com/anthropics/claude-code/issues/86755) | Auto-mode classifier degraded: blocking read-only commands (ls, gh issue view) inconsistently within one session | nickwarters | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:permissions, bug, platform:macos |
| [#86753](https://github.com/anthropics/claude-code/issues/86753) | PostToolUse hookSpecificOutput.updatedToolOutput silently ignored when shape doesn't match tool's native output | guyversa74 | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:hooks, bug, has repro |
| [#86754](https://github.com/anthropics/claude-code/issues/86754) | VS Code extension: PreToolUse 'ask' permission tier (static rules + hooks) silently resolves to allow, no prompt shown | guyversa74 | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:hooks, area:permissions, bug, has repro, platform:vscode |
| [#71421](https://github.com/anthropics/claude-code/issues/71421) | \[BUG\] @ file picker search quality is poor compared to VS Code — surfaces irrelevant files from node\_modules/deep paths | RHawkins-Fisher | CLOSED / NOT\_PLANNED | 0 | 1 | 2026-08-14 | 2026-06-25 | area:desktop, area:ui, bug, platform:macos |
| [#76688](https://github.com/anthropics/claude-code/issues/76688) | \[BUG\] Opus 4.8 subagents die on turn 1 emitting fabricated System:/Assistant: scaffolding (0 tool calls, &lt;br&gt;+System: prefix) — 13x in one session, JSONL-verified, spawn-time variant of #68367 | DBAElegance | OPEN | 0 | 2 | 2026-08-14 | 2026-07-11 | api:anthropic, area:agents, area:model, bug, has repro, platform:macos |
| [#86752](https://github.com/anthropics/claude-code/issues/86752) | \[BUG\] "Can't rewind to this message" for every target older than the newest mid-turn queued message — \`queued\_command\` uuid rewrite breaks the Desktop active-chain walk | thomasbachem | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:desktop, bug, has repro, platform:macos |
| [#80860](https://github.com/anthropics/claude-code/issues/80860) | \[Bug\] Claude Code not following user directives and providing inaccurate task execution reports | jamieo1337 | OPEN | 1 (❤️ 1) | 1 | 2026-08-14 | 2026-07-24 | — |
| [#86751](https://github.com/anthropics/claude-code/issues/86751) | You've hit your session limit · resets 4:40am (Asia/Calcutta) | evanpaul90 | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:cost, bug, needs-repro, platform:macos |
