...
|---:|---|---|---|---:|---:|---|---|---|
| [#6235](https://github.com/anthropics/claude-code/issues/6235) | Feature Request: Support AGENTS.md. | DylanLIiii | OPEN | 5888 (👍 4553 · 👎 10 · 😄 33 · 🎉 293 · 😕 5 · ❤️ 397 · 🚀 330 · 👀 267) | 349 | 2026-08-14 | 2025-08-21 | area:core, enhancement, memory |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86651](https://github.com/anthropics/claude-code/issues/86651) | \[BUG\] Pending background-task notification is absorbed into a slash command's &lt;command-args&gt; / $ARGUMENTS, corrupting the prompt and exposing raw internal tags | redsand2 | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:core, bug, platform:windows |
| [#85199](https://github.com/anthropics/claude-code/issues/85199) | \[BUG\]Claude Desktop repeatedly crashes and requires “Advanced Options → Repair” on Windows | romers352 | OPEN | 2 (👍 2) | 16 | 2026-08-14 | 2026-08-09 | bug |
| [#86238](https://github.com/anthropics/claude-code/issues/86238) | Bundled ugrep runs with no memory limit or timeout — model-generated regex consumed 13.6 GB and thrashed the host | hizawye | OPEN | 1 (👍 1) | 1 | 2026-08-14 | 2026-08-13 | — |
| [#86650](https://github.com/anthropics/claude-code/issues/86650) | \[BUG\]\[SDK\] task-notification resumes a stopped turn with an already-aborted AbortController — every later tool\_use is cancelled and reported as a user refusal | CARL-Bouvet | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:agent-sdk, area:agents, bug |
| [#86649](https://github.com/anthropics/claude-code/issues/86649) | Pre-approve apps for computer-use MCP so unattended sessions are possible (refiling #46907, locked) | EtienneLescot | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:mcp, area:permissions, enhancement |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86648](https://github.com/anthropics/claude-code/issues/86648) | \[BUG\] Web tab lists local CLI-only conversations; opening them always fails with "No conversation found with session ID" and leaves a new empty teleport stub each time | PatriceVigier | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:claude-code-web, area:ide, bug, has repro, platform:intellij, platform:windows |
| [#84918](https://github.com/anthropics/claude-code/issues/84918) | \[FEATURE\]  Session/chat history and memory in Claude Code are keyed entirely to the project folder's absolute filesystem path, with no way to preserve continuity when the folder is moved or renamed. | Gene-Howard | OPEN | 0 | 3 | 2026-08-14 | 2026-08-07 | enhancement |
| [#86647](https://github.com/anthropics/claude-code/issues/86647) | \[BUG\] Cowork session reports zero connected folders while the project UI shows a folder as connected | dionysis123 | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:cowork, area:desktop, bug, platform:macos |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 3 (👍 3) | 12 | 2026-08-14 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#74043](https://github.com/anthropics/claude-code/issues/74043) | Session becomes inaccessible via --resume / desktop UI despite intact .jsonl transcript (stale session index after directory path change) | Schmed | OPEN | 1 (👍 1) | 2 | 2026-08-14 | 2026-07-04 | area:core, bug, platform:macos |
| [#86645](https://github.com/anthropics/claude-code/issues/86645) | \[BUG\] VSCode extension repeatedly asks for permission to edit files, even if Auto is selected | Konrud | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:permissions, bug, platform:vscode, platform:windows |
| [#86646](https://github.com/anthropics/claude-code/issues/86646) | \[BUG\] | Grumpfield-the-Cat | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:bash, bug, has repro, platform:windows |
| [#85794](https://github.com/anthropics/claude-code/issues/85794) | \[BUG\] Claude desktop session indexing bug | KaribuOS | OPEN | 1 (👍 1) | 5 | 2026-08-14 | 2026-08-11 | area:desktop, bug, has repro, platform:windows |
| [#74260](https://github.com/anthropics/claude-code/issues/74260) | Assistant text blocks silently dropped when followed by more thinking in the same turn — never rendered, missing from transcript JSONL (2.1.201, adaptive thinking) | federbenjamin | OPEN | 24 (👍 23 · 😄 1) | 29 | 2026-08-14 | 2026-07-04 | area:core, area:tui, bug, data-loss, has repro, platform:linux, platform:macos, platform:windows |
| [#43869](https://github.com/anthropics/claude-code/issues/43869) | Subagent model routing is broken — all mechanisms resolve to parent model (Opus) | zadr007 | OPEN | 29 (👍 17 · 🎉 3 · ❤️ 3 · 🚀 3 · 👀 3) | 14 | 2026-08-14 | 2026-04-05 | area:agents, area:model, bug, has repro, platform:windows |
| [#28791](https://github.com/anthropics/claude-code/issues/28791) | \[FEATURE\] Sync conversation history between CLI and Claude Code desktop app | moazam1 | OPEN | 147 (👍 124 · 🚀 23) | 35 | 2026-08-14 | 2026-02-26 | area:cli, area:desktop, enhancement |
| [#86644](https://github.com/anthropics/claude-code/issues/86644) | (withdrawn) | eos1dmarkiin | CLOSED / NOT\_PLANNED | 0 | 0 | 2026-08-14 | 2026-08-14 | area:model, area:permissions, bug, platform:windows |
| [#86643](https://github.com/anthropics/claude-code/issues/86643) | \[BUG\] Runaway memory growth in Claude Code child process causes full system freeze (Ubuntu 24.04, requires hard reboot) | tipikae | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:core, duplicate, perf:memory, platform:linux |
| [#86640](https://github.com/anthropics/claude-code/issues/86640) | \[MODEL\] Coordinator adopts subagent report's coined labels and register in user-facing messages | rickrebel | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | api:anthropic, area:agents, area:model, bug |
| [#76192](https://github.com/anthropics/claude-code/issues/76192) | Relaunch fails: 'program is currently using this file' (file-lock on relaunch, Windows) | adleruva-hub | OPEN | 0 | 2 | 2026-08-14 | 2026-07-09 | area:desktop, bug, platform:windows |
| [#86641](https://github.com/anthropics/claude-code/issues/86641) | \[BUG\] Desktop: ⌘/ never opens the shortcuts list on layouts where / needs Shift – it toggles an ordered list instead | thomasbachem | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:desktop, bug, keybindings, platform:macos |
| [#86642](https://github.com/anthropics/claude-code/issues/86642) | \[FEATURE\] Desktop: keyboard shortcut for Reply and Attach selection as context | thomasbachem | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:desktop, enhancement, keybindings, platform:macos |
| [#78002](https://github.com/anthropics/claude-code/issues/78002) | \[BUG\] Desktop: zoom shortcuts bound to physical US key positions — wrong keys on non-US (Norwegian) layout | hakonhagland | OPEN | 0 | 1 | 2026-08-14 | 2026-07-16 | area:desktop, bug, keybindings, platform:linux |
| [#81859](https://github.com/anthropics/claude-code/issues/81859) | \[Bug\] OTel claude\_code.user\_prompt only emitted for slash-command dispatches; regular prompt submissions emit no event | jpuffer | OPEN | 1 (👍 1) | 2 | 2026-08-14 | 2026-07-28 | — |
| [#85517](https://github.com/anthropics/claude-code/issues/85517) | \[BUG\] Claude in Chrome file\_upload: eligible files fail with -32602 "paths received undefined" in interactive Cowork sessions (Windows) — related to #84880 / #85107 / #63334 | ClaudesWife | CLOSED / COMPLETED | 0 | 5 | 2026-08-14 | 2026-08-10 | bug |
