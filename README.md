...
|---:|---|---|---|---:|---:|---|---|---|
| [#6235](https://github.com/anthropics/claude-code/issues/6235) | Feature Request: Support AGENTS.md. | DylanLIiii | OPEN | 5891 (👍 4556 · 👎 10 · 😄 33 · 🎉 293 · 😕 5 · ❤️ 397 · 🚀 330 · 👀 267) | 349 | 2026-08-14 | 2025-08-21 | area:core, enhancement, memory |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86667](https://github.com/anthropics/claude-code/issues/86667) | Claude Code bypassed a blocked system-path guard via 'cmd /c rd', then a destructive command silently continued unsupervised in the background after timeout — wiped C:\\ drive root | HN84956371-code | OPEN | 0 | 1 | 2026-08-14 | 2026-08-14 | area:sandbox, area:security, bug, data-loss, has repro, high-priority, platform:windows |
| [#86668](https://github.com/anthropics/claude-code/issues/86668) | Desktop app (Windows): no task/todo list view — TodoWrite tool not available in GUI sessions | TheDarkMist | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | — |
| [#54614](https://github.com/anthropics/claude-code/issues/54614) | \[FEATURE\] Open Claude Desktop in a specific folder via CLI flag or deep link (new Code session, not Cowork home) | gsamat | OPEN | 12 (👍 12) | 7 | 2026-08-14 | 2026-04-29 | area:desktop, enhancement, platform:macos |
| [#86142](https://github.com/anthropics/claude-code/issues/86142) | MCP servers declaring draft-07 outputSchema are entirely unusable: "unsupported dialect" rejected client-side before dispatch | amitfin | OPEN | 3 (👍 3) | 5 | 2026-08-14 | 2026-08-12 | area:mcp, bug, has repro, platform:macos |
| [#50884](https://github.com/anthropics/claude-code/issues/50884) | \[FEATURE\] Let users remove stale/dead Remote Control environments from the claude.ai/code environment list | wolfomania | OPEN | 29 (👍 29) | 9 | 2026-08-14 | 2026-04-19 | area:claude-code-web, area:cli, enhancement |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#52121](https://github.com/anthropics/claude-code/issues/52121) | Grep and Glob tools missing entirely from registry under ENABLE\_TOOL\_SEARCH=true | saminstacart | OPEN | 21 (👍 21) | 19 | 2026-08-14 | 2026-04-22 | area:tools, bug, has repro, platform:macos |
| [#78695](https://github.com/anthropics/claude-code/issues/78695) | Remote Control: stale environment registrations cannot be removed from claude.ai/code picker | madhu-korada | OPEN | 1 (👍 1) | 1 | 2026-08-14 | 2026-07-17 | area:cli, duplicate, platform:linux |
| [#83994](https://github.com/anthropics/claude-code/issues/83994) | \[Bug\] Anthropic API Error: ECONNRESET with exhausted retries in Claude desktop app | vidarraesir | OPEN | 4 (👍 4) | 11 | 2026-08-14 | 2026-08-05 | — |
| [#86666](https://github.com/anthropics/claude-code/issues/86666) | \[Feature Request\] Share session with teammates for collaborative multi-user discussions | narley | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:core, enhancement, platform:macos |
| [#66516](https://github.com/anthropics/claude-code/issues/66516) | \[BUG\] Claude Desktop macOS window stays always on top of other apps | tekgrlpdx | CLOSED / NOT\_PLANNED | 0 | 5 | 2026-08-14 | 2026-06-09 | invalid |
| [#73870](https://github.com/anthropics/claude-code/issues/73870) | \[Bug\] Incorrect Fable 5 limit error when using Opus model | myavuzkaplan | OPEN | 0 | 1 | 2026-08-14 | 2026-07-03 | area:model, duplicate, platform:macos |
| [#85979](https://github.com/anthropics/claude-code/issues/85979) | \[BUG\] \[BUG\] Persistent ECONNRESET on v2.1.228 (post-fix) — all networks, all local causes eliminated incl. full AV uninstall; claude.ai chat works fine on same account | kogaEG0509 | OPEN | 0 | 6 | 2026-08-14 | 2026-08-12 | api:anthropic, area:networking, bug, has repro, platform:windows |
| [#84951](https://github.com/anthropics/claude-code/issues/84951) | \[BUG\] Desktop app (Windows) crashes/hangs while using the built-in Claude Browser pane; one crash reset the app profile | SammyDoe | OPEN | 2 (👍 2) | 7 | 2026-08-14 | 2026-08-07 | bug |
| [#86214](https://github.com/anthropics/claude-code/issues/86214) | \[BUG\] Cross-session message sender renders fused to the prompt glyph (no separator before ❯) | bZichett | OPEN | 0 | 1 | 2026-08-14 | 2026-08-12 | area:agents, area:tui, bug, platform:linux |
| [#86604](https://github.com/anthropics/claude-code/issues/86604) | PR-activity webhook events render as if the user sent them, and non-actionable bot comment-edits are relayed with full raw payloads | timshelxyz | OPEN | 0 | 1 | 2026-08-14 | 2026-08-14 | area:claude-code-web, area:ui, bug, platform:web |
| [#86619](https://github.com/anthropics/claude-code/issues/86619) | \[BUG\] Windows Git Bash: static analysis false-positives on read-only cd-compound commands cause constant, unsuppressable permission prompts (since 2.1.232 / auto-mode rollout) | Aura-Intel | OPEN | 2 (👍 2) | 3 | 2026-08-14 | 2026-08-14 | area:bash, area:permissions, bug, has repro, platform:windows |
| [#86603](https://github.com/anthropics/claude-code/issues/86603) | \[BUG\] send\_message reports success on native Windows where cross-session messaging is not offered — no inbox socket bound, nothing delivered, caller cannot tell (worked on this machine until 2026-08-11) | Neverbet | OPEN | 0 | 4 | 2026-08-14 | 2026-08-14 | area:agents, area:desktop, bug, has repro, platform:windows, regression |
| [#72156](https://github.com/anthropics/claude-code/issues/72156) | \[BUG\] /feedback submissions should allow for redaction/scrubbing/audit of PII/Secrets before submission | jp-cruz | OPEN | 2 (👍 2) | 8 | 2026-08-14 | 2026-06-28 | area:security, enhancement |
| [#82092](https://github.com/anthropics/claude-code/issues/82092) | \[BUG\]  Apps gateway serves Claude Desktop an \`otlpEndpoint\` pointing at its own bearer-gated OTLP ingest but no \`otlpHeaders\`, so every Desktop telemetry flush is rejected with \`missing\_token\` | k-brooks | OPEN | 5 (👍 5) | 12 | 2026-08-14 | 2026-07-28 | bug |
| [#86665](https://github.com/anthropics/claude-code/issues/86665) | \[Bug\] Anthropic API Error: Invalid JSON Schema in Tool Definition | iniadil | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:tools, bug, platform:macos |
| [#80049](https://github.com/anthropics/claude-code/issues/80049) | \[BUG\] Claude-code steals KeyBoard Focus without warning or delay -- causes user to type in wrong window prompt | PaulCharlton | OPEN | 1 (👍 1) | 3 | 2026-08-14 | 2026-07-22 | bug |
| [#86664](https://github.com/anthropics/claude-code/issues/86664) | \[Bug\] Anthropic API Error: Status 400 for Use Tool | iniadil | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:tools, bug, platform:macos |
| [#86663](https://github.com/anthropics/claude-code/issues/86663) | \[BUG\] claude beta plugin + plugin classic ui =&gt; no claude icon | RogerKratz | OPEN | 0 | 0 | 2026-08-14 | 2026-08-14 | area:ide, bug, platform:intellij, platform:windows |
| [#86662](https://github.com/anthropics/claude-code/issues/86662) | Claude | kyledykes1-cell | CLOSED / COMPLETED | 0 | 0 | 2026-08-14 | 2026-08-14 | invalid |
| [#84021](https://github.com/anthropics/claude-code/issues/84021) | \[BUG\] Hook output over 10K silently dropped from context with zero signal — memory plugins lose injected data invisibly | Alex-Fleet | OPEN | 0 | 3 | 2026-08-14 | 2026-08-05 | — |
