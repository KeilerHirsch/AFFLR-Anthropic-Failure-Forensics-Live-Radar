...
| [#87062](https://github.com/anthropics/claude-code/issues/87062) | \[BUG\] macOS: long sessions die with ECONNRESET — macOS TCP send-buffer default (autosndbufmax=4MB) bursts the growing context upload; one sysctl fixes it | INTEGRITY2077 | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:networking, bug, has repro, platform:macos |
...
| [#79076](https://github.com/anthropics/claude-code/issues/79076) | \[Bug\]\[cyber\] Android emulation research on attestation verification incorrectly flagged (req\_011CdAm3HbnWAqT8paFFjzKm) | sworrl | OPEN | 1 (👍 1) | 2 | 2026-08-16 | 2026-07-19 | — |
| [#72100](https://github.com/anthropics/claude-code/issues/72100) | \[Bug\]\[aup\] SSH key check and git host auth test wrongly blocked during routine developer setup (req\_011CcUE5fyE9yUvTdjxJN75m) | sworrl | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-16 | 2026-06-28 | area:model, bug, duplicate, platform:linux |
| [#79071](https://github.com/anthropics/claude-code/issues/79071) | \[Bug\]\[cyber\] Blocked legitimate Android Xposed framework module development (req\_011CcqLXpYvH597bs27LBwiD) | sworrl | OPEN | 1 (👍 1) | 2 | 2026-08-16 | 2026-07-19 | — |
| [#73516](https://github.com/anthropics/claude-code/issues/73516) | \[Bug\] Code migration incomplete - Claude omits features without explicit notification | BillSnee | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-02 | area:model, bug, platform:macos |
| [#79063](https://github.com/anthropics/claude-code/issues/79063) | \[Bug\]\[cyber\] Safety block halts legitimate system admin query about software feature limitations (req\_011Cd1a8HRwSkaBrFnY7LtPh) | sworrl | OPEN | 1 (👍 1) | 2 | 2026-08-16 | 2026-07-19 | — |
| [#72003](https://github.com/anthropics/claude-code/issues/72003) | \[Bug\]\[cyber\] False block halts authorized defensive security automation app development (req\_011CcV5RdTBsufs4i5UgJgz3) | sworrl | CLOSED / NOT\_PLANNED | 0 | 5 | 2026-08-16 | 2026-06-28 | area:model, area:security, bug, duplicate, platform:linux |
| [#72002](https://github.com/anthropics/claude-code/issues/72002) | \[Bug\]\[cyber\] ClAudit false-positive in DJI — req\_011CcV5NpEk128mDCbCi2CZa | sworrl | CLOSED / NOT\_PLANNED | 0 | 3 | 2026-08-16 | 2026-06-28 | area:model, area:security, bug, duplicate, platform:linux |
| [#71998](https://github.com/anthropics/claude-code/issues/71998) | \[Bug\]\[cyber\] Safety block halted reverse-engineering of a vendor SDK's white-box AES decrypt routine (req\_011CcV5NTXoGuPu7Ju6gDkxg) | sworrl | CLOSED / NOT\_PLANNED | 0 | 5 | 2026-08-16 | 2026-06-28 | area:model, area:security, bug, duplicate, platform:linux |
| [#71996](https://github.com/anthropics/claude-code/issues/71996) | \[Bug\]\[cyber\] Blocked while reviewing a decompiled white-box AES class for app interop work (req\_011CcV5MVf2AARSr2duriXsi) | sworrl | CLOSED / NOT\_PLANNED | 0 | 6 | 2026-08-16 | 2026-06-28 | area:model, area:security, duplicate, platform:linux |
| [#71994](https://github.com/anthropics/claude-code/issues/71994) | \[Bug\]\[cyber\] ClAudit false-positive in DJI — req\_011CcV5MAAVyWRSqA8yDWNbJ | sworrl | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-16 | 2026-06-28 | area:model, area:security, duplicate, platform:linux |
| [#71990](https://github.com/anthropics/claude-code/issues/71990) | \[Bug\]\[cyber\] ClAudit false-positive in DJI — req\_011CcV5L5hq98qxRQDB2Y9aG | sworrl | CLOSED / NOT\_PLANNED | 0 | 4 | 2026-08-16 | 2026-06-28 | area:model, duplicate, platform:linux |
| [#71993](https://github.com/anthropics/claude-code/issues/71993) | \[Bug\]\[cyber\] Safety block halted legitimate reverse-engineering of a white-box AES decryption routine (req\_011CcV5M1QeTZMuGBQruYXZf) | sworrl | CLOSED / NOT\_PLANNED | 0 | 5 | 2026-08-16 | 2026-06-28 | area:model, area:security, bug, duplicate, platform:linux |
