...
| Issue | Title | State | Signal | Updated | Created | Labels |
|---:|---|---|---|---|---|---|
| [#87915](https://github.com/anthropics/claude-code/issues/87915) | skill-creator: run\_eval.py writes skills to .claude/commands/, so description optimization always measures recall=0% | OPEN | security / trust boundary · observation / provenance integrity | 2026-08-19 | 2026-08-19 | — |
