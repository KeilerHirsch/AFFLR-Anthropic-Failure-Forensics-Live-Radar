...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86651](https://github.com/anthropics/claude-code/issues/86651) | \[BUG\] Pending background-task notification is absorbed into a slash command's &lt;command-args&gt; / $ARGUMENTS, corrupting the prompt and exposing raw internal tags | redsand2 | OPEN | 0 | 1 | 2026-08-15 | 2026-08-14 | area:core, bug, platform:windows |
| [#86298](https://github.com/anthropics/claude-code/issues/86298) | Desktop app (Windows): cross-session messages silently dropped — held for an approval the UI never offers, then expire (~5 min); regression since app 1.28929.0 | arthurmoraesfernandes-afk | OPEN | 1 (👍 1) | 11 | 2026-08-15 | 2026-08-13 | area:desktop, bug, has repro, platform:windows, regression |
| [#86743](https://github.com/anthropics/claude-code/issues/86743) | \[BUG\] defer\_loading + cache\_control 400 still present in 2.1.223 (recurrence of #30920) | BK0STAR | OPEN | 0 | 1 | 2026-08-15 | 2026-08-14 | api:anthropic, area:mcp, area:tools, bug, has repro, platform:macos |
| [#83841](https://github.com/anthropics/claude-code/issues/83841) | macOS 26: "claude.app would like to access data from other apps" re-prompts on every Claude Code session launch and cannot be cleared | Stan1sLove | OPEN | 1 (👍 1) | 2 | 2026-08-15 | 2026-08-04 | — |
| [#86929](https://github.com/anthropics/claude-code/issues/86929) | \[Bug\] TaskCreate/TaskUpdate tools missing from deferred tool list | thehikers | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:tools, area:tui, bug, platform:macos |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#80210](https://github.com/anthropics/claude-code/issues/80210) | Task/Todo tools (TaskCreate/TodoWrite) not exposed despite \`todoFeatureEnabled: true\` — regressed ~2026-07-21, appears account-gated | Jason-Mendes | CLOSED / COMPLETED | 4 (👍 4) | 9 | 2026-08-15 | 2026-07-22 | — |
| [#86928](https://github.com/anthropics/claude-code/issues/86928) | Sandboxed Bash intermittently fails: apply-seccomp: unshare(CLONE\_NEWUSER): Invalid argument | Xiaokebuyu | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:sandbox, bug, has repro, platform:linux |
| [#86671](https://github.com/anthropics/claude-code/issues/86671) | \[BUG\] Cross-session messages are displayed in the target session but never enqueued (model never sees them) | Vincent-92 | OPEN | 1 (👍 1) | 2 | 2026-08-15 | 2026-08-14 | area:agents, area:desktop, duplicate, platform:windows, regression |
| [#85101](https://github.com/anthropics/claude-code/issues/85101) | Claude in Chrome: extension binds native host successfully but CLI always reports "Browser extension is not connected" | OfficialUlix | OPEN | 0 | 1 | 2026-08-15 | 2026-08-08 | — |
| [#86927](https://github.com/anthropics/claude-code/issues/86927) | \[BUG\] Windows Git Bash: Bash tool brace-expands inside quoted strings and splits quoted paths containing spaces | JairOliveiraS | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:bash, bug, has repro, platform:windows |
| [#86926](https://github.com/anthropics/claude-code/issues/86926) | Distinguish Timeout and TooComplex from Denied in permission outcomes | peterdrier | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:permissions, enhancement |
| [#86925](https://github.com/anthropics/claude-code/issues/86925) | \[FEATURE\] Desktop: setting to make split view the default when opening a session | ferhado | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:desktop, enhancement |
| [#86924](https://github.com/anthropics/claude-code/issues/86924) | \[Feature Request\] Configurable editor for plan mode instead of platform default | ericnewton76 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:tui, enhancement, platform:vscode, platform:windows |
| [#86923](https://github.com/anthropics/claude-code/issues/86923) | \[Feature Request\] Display editor access keybinding for plan mode in help area | ericnewton76 | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:tui, enhancement, platform:vscode, platform:windows |
