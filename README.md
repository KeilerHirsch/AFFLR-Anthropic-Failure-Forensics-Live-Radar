...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#86812](https://github.com/anthropics/claude-code/issues/86812) | \[Bug\] Unexpected high token consumption in single conversation session | KoldAd1b | OPEN | 0 | 1 | 2026-08-15 | 2026-08-15 | area:cost, bug, needs-repro, platform:macos, platform:vscode |
| [#81707](https://github.com/anthropics/claude-code/issues/81707) | \[BUG\] macOS: Claude Code locks itself out of its own keychain credential → endless "security wants to access Claude Code-credentials" password prompts | Frenchie-Juice | OPEN | 2 (👍 2) | 2 | 2026-08-15 | 2026-07-27 | bug |
| [#86855](https://github.com/anthropics/claude-code/issues/86855) | Sandbox: bwrap fails when auto-generated .env deny path resolves through symlink into read-only /nix/store | gegnep | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:sandbox, duplicate, platform:linux |
| [#86844](https://github.com/anthropics/claude-code/issues/86844) | Login/verification emails never delivered — address appears to be on the email suppression list | berkue | CLOSED / COMPLETED | 0 | 1 | 2026-08-15 | 2026-08-15 | area:auth, bug, platform:macos |
| [#85133](https://github.com/anthropics/claude-code/issues/85133) | \[BUG\] Update cloud environment: "Failed to update environment. You can try again." — Save always fails for both Full-access preset and Custom allowlist | kukkadumas | OPEN | 0 | 2 | 2026-08-15 | 2026-08-08 | — |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#81425](https://github.com/anthropics/claude-code/issues/81425) | VS Code/Cursor extension: session hangs forever after auto-mode classifier\_request\_finished (no timeout, webview channel errors silenced) | Max-Mendes91 | OPEN | 0 | 2 | 2026-08-15 | 2026-07-26 | — |
| [#86854](https://github.com/anthropics/claude-code/issues/86854) | \[BUG\] VS Code extension (Remote-SSH): per-event stream rendering delays permission prompts by minutes-to-hours with fine-grained SSE providers | Jeromefromcn | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:ide, bug, has repro, platform:linux, platform:vscode |
| [#86853](https://github.com/anthropics/claude-code/issues/86853) | Bash tool never surfaces stdout; ordinary commands (echo, printf, date, bare pwd) fail with bare Exit code 1 | datmt | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:bash, bug, platform:linux |
| [#66516](https://github.com/anthropics/claude-code/issues/66516) | \[BUG\] Claude Desktop macOS window stays always on top of other apps | tekgrlpdx | CLOSED / NOT\_PLANNED | 0 | 7 | 2026-08-15 | 2026-06-09 | invalid |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 4 (👍 4) | 20 | 2026-08-15 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#86016](https://github.com/anthropics/claude-code/issues/86016) | \[BUG\] \[BUG\] セッション間メッセージ送信後、セッションがisRunning:trueのまま応答せず凍結する | fusionpartnersoffice-oss | OPEN | 0 | 4 | 2026-08-15 | 2026-08-12 | area:agent-view, bug, platform:windows |
| [#86852](https://github.com/anthropics/claude-code/issues/86852) | Long-running autonomous sessions reported dependency-removal progress that never reduced the actual dependency | petrinhu | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:agents, enhancement |
| [#86851](https://github.com/anthropics/claude-code/issues/86851) | Desktop app: latest assistant messages stop rendering while the transcript on disk stays complete and intact | mong7298-alt | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:desktop, area:ui, bug, has repro, platform:macos |
| [#86850](https://github.com/anthropics/claude-code/issues/86850) | your bot keeps changing its effort level on command and not starting the sessions at the right effort level | michaelbentley2006-jpg | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:model, bug, platform:vscode, platform:windows |
| [#86849](https://github.com/anthropics/claude-code/issues/86849) | Stale background-task notifications keep re-firing in long sessions | larsadolfsen | OPEN | 0 | 0 | 2026-08-15 | 2026-08-15 | area:agent-view, bug, platform:windows |
