...
| Issue | Title | State | Signal | Updated | Created | Labels |
|---:|---|---|---|---|---|---|
| [#88817](https://github.com/anthropics/claude-code/issues/88817) | Browser pane screenshot crashes GPU process (exitCode 101457950), app becomes unlaunchable and requires OS repair | OPEN | security / trust boundary | 2026-08-22 | 2026-08-22 | area:desktop, bug, duplicate, platform:windows |
...
| [#88795](https://github.com/anthropics/claude-code/issues/88795) | Read tool ignores permissions.deny Read(/Users/\*\*) rules in managed-settings.json and user settings.json | OPEN | security / trust boundary · high-signal label | 2026-08-22 | 2026-08-22 | area:permissions, area:security, bug, has repro, platform:macos |
| [#88791](https://github.com/anthropics/claude-code/issues/88791) | \[Bug\] Read/Write/Edit tools not invoked in auto/bypass modes | OPEN | security / trust boundary · high-signal label | 2026-08-22 | 2026-08-22 | area:permissions, area:tools, bug, platform:windows |
