...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87134](https://github.com/anthropics/claude-code/issues/87134) | Model reinterpreted an explicit instruction, killed running subagents unasked, and asserted a capability limit without checking it | Nagyhoho1234 | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | area:agents, area:model, bug |
| [#73657](https://github.com/anthropics/claude-code/issues/73657) | \[Bug\] Anthropic API Error: Server Rate Limiting During Normal Usage | Sahasrara | CLOSED / DUPLICATE | 0 | 1 | 2026-08-16 | 2026-07-03 | api:anthropic, area:api, bug, platform:windows |
| [#83356](https://github.com/anthropics/claude-code/issues/83356) | \[BUG\] prose from Opus/Fable has gotten pretty much inscrutable | nlebovits | CLOSED / COMPLETED | 0 | 1 | 2026-08-16 | 2026-08-02 | — |
| [#83633](https://github.com/anthropics/claude-code/issues/83633) | \[BUG\] Login authenticates but has\_finished\_claudeai\_onboarding=false walls existing paid Max account behind new-account onboarding (web/desktop/setup-token) — 10th public report of this signature, first with the mechanism captured on the wire | VICTech-admin | OPEN | 0 | 20 | 2026-08-16 | 2026-08-03 | bug |
| [#27302](https://github.com/anthropics/claude-code/issues/27302) | \[FEATURE\] Support multiple Connector accounts (same connector, different accounts) in Claude and Claude Code on the web (claude.ai/code) | nathanmargaglio | OPEN | 485 (👍 346 · ❤️ 110 · 🚀 16 · 👀 13) | 230 | 2026-08-16 | 2026-02-21 | enhancement |
...
| Issue | Title | Author | State | Reactions | Comments | Updated | Created | Labels |
|---:|---|---|---|---:|---:|---|---|---|
| [#87130](https://github.com/anthropics/claude-code/issues/87130) | \[FEATURE\] Support more than one IDE-connected Claude Code session per editor window | Kareem-AEz | OPEN | 1 (👍 1) | 2 | 2026-08-16 | 2026-08-16 | area:ide, enhancement |
...
| [#87133](https://github.com/anthropics/claude-code/issues/87133) | \[BUG\] Claude Code内蔵のArtifactプレビューで、白背景のボタン（ghostスタイル）の文字が表示されない | takaaki-moriki | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:ui, bug, has repro, platform:macos |
| [#86069](https://github.com/anthropics/claude-code/issues/86069) | \[BUG\] Windows/MSIX 1.28929.0: cross-session messages land in the target's composer but are never submitted — session never responds | lschlegel9826 | OPEN | 5 (👍 5) | 29 | 2026-08-16 | 2026-08-12 | area:agents, bug, has repro, platform:windows, regression |
| [#87131](https://github.com/anthropics/claude-code/issues/87131) | Parking a mid-flight turn leaves the interactive session's probe stuck at status: "busy" forever (2.1.220) | penard-monkey | OPEN | 0 | 0 | 2026-08-16 | 2026-08-16 | area:core, bug, has repro, platform:macos |
| [#87129](https://github.com/anthropics/claude-code/issues/87129) | \[BUG\] Embedded ugrep hangs indefinitely (pegged core) on unanchored bounded-repetition pattern — the same binary's embedded ripgrep finishes in 53 ms | dperezcabrera | OPEN | 0 | 1 | 2026-08-16 | 2026-08-16 | area:bash, bug, has repro, platform:linux |
...
| [#62462](https://github.com/anthropics/claude-code/issues/62462) | Cannot copy text from Claude responses in interactive TUI (GNOME Terminal, Ubuntu 24.04) | Chawer1 | OPEN | 12 (👍 12) | 12 | 2026-08-16 | 2026-05-26 | — |
| [#77830](https://github.com/anthropics/claude-code/issues/77830) | Commit \`Claude-Session:\` attribution trailer ignores \`attribution: {commit: ""}\` setting | rustyrazorblade | OPEN | 1 (👍 1) | 6 | 2026-08-16 | 2026-07-15 | bug, documentation, has repro, platform:macos, reproduced |
| [#20826](https://github.com/anthropics/claude-code/issues/20826) | \[BUG\] Cursor IDE integration fails: option disappears after brief availability | PrzemyslawLeszek | OPEN | 2 (👍 2) | 4 | 2026-08-16 | 2026-01-25 | area:ide, area:mcp, bug, has repro, platform:windows |
| [#86088](https://github.com/anthropics/claude-code/issues/86088) | Windows Desktop: turns initiated while session window is unfocused (cross-session send\_message delivery) never start; watchdog-killed after ~980s — regression 2.1.222 -&gt; 2.1.227 | 007ArunSharma | OPEN | 1 (👍 1) | 3 | 2026-08-16 | 2026-08-12 | area:agents, area:desktop, duplicate, has repro, platform:windows, regression |
| [#79136](https://github.com/anthropics/claude-code/issues/79136) | You've hit your session limit · resets 10:30pm (Europe/Berlin) | diliuskh | OPEN | 0 | 2 | 2026-08-16 | 2026-07-19 | area:cost, bug, duplicate, platform:macos |
